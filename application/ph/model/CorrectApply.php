...
class CorrectApply extends Model
{
    // 设置当前模型对应的完整数据表名称
...
//halt($where);
    ...
    public function get_one_change_info($id = '' ,$map=''){
        ...
        if(!$map) $map='ChangeOrderID ,HouseID ,HouseUsearea,BanAddress,OldTenantName,NewTenantName, HousePrerent, OwnerType,InstitutionID ,UserNumber ,CreateTime ,Status';
