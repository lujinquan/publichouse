    ...
    $.get('/ph/Api/get_rent_table_detail/HouseID/' + HouseID, function(res) {
        ...
        for (var a = 0; a < RentA.length; a++) {
            ...
            for (var j = 0; j < RentRoom[num].length; j++) {
                ...
                + '<li style="width:5%" class="RentMp">' + res.data.roomDetail[num][j].RoomPrerent + '</li>' + '<li style="width:4%" class="RentMp">' + res.data.roomDetail[num][j].RoomRentMonth + '</li>'+'<li style="width:4%" class="RentStatus">' + res.data.roomDetail[num][j].Status + '</li></ul>';
