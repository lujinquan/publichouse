<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:58:"D:\phpStudy\WWW\ph/application/ph\view\rent_pre\index.html";i:1527069861;s:50:"D:\phpStudy\WWW\ph/application/ph\view\layout.html";i:1527069860;s:40:"application/ph/view/rent_pre/detail.html";i:1526272118;s:43:"application/ph/view/notice/notice_info.html";i:1523846106;s:42:"application/ph/view/index/second_menu.html";i:1523846106;}*/ ?>
<!doctype html>
<html class="no-js">
<head>
  <meta charset="utf-8">
		    ...
		    <tr class="am-form-group am-form-inline am-form">
              ...
              <td>
                  <div class="am-input-group am-input-group-sm" style="width:150px;">
                      <?php
                        if($preRentOption != array()){
                            $DateStart = $preRentOption['DateStart'];
                            $DateEnd = $preRentOption['DateEnd'];
                        }else{
                            $DateStart = '';
                            $DateEnd = '';
                        }
                      ?>
                      <input style="width:70px;" name="DateStart" value="<?php echo $DateStart; ?>" type="text" class="am-form-field" data-am-datepicker value="">
                      <input style="width:70px;" name="DateEnd" value="<?php echo $DateEnd; ?>" type="text" class="am-form-field" data-am-datepicker value="">
                  </div>
              </td>
              <td>
...
<!-- 	<div class="am-form-group am-u-sm-12">
	...
	<div class="am-form-group am-u-sm-12">
		<div class="am-form-group am-u-sm-6">
			<div class="am-u-md-4 l_change">房屋ID：</div><input class="am-u-md-8 houseID"  id="houseID" />
		</div>
...
<script type="text/javascript" src="/public/static/gf/viewJs/rent_pre.js"></script>
