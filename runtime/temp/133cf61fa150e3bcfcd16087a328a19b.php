<?php if (!defined('THINK_PATH')) exit(); /*a:8:{s:71:"/usr/share/nginx/publichouse/application/ph/view/tenant_info/index.html";i:1528342025;s:60:"/usr/share/nginx/publichouse/application/ph/view/layout.html";i:1534760328;s:41:"application/ph/view/tenant_info/form.html";i:1537066000;s:43:"application/ph/view/tenant_info/detail.html";i:1537066000;s:43:"application/ph/view/tenant_info/modify.html";i:1537066000;s:43:"application/ph/view/notice/notice_info.html";i:1528342025;s:42:"application/ph/view/index/second_menu.html";i:1531059200;s:38:"application/ph/view/index/version.html";i:1537405974;}*/ ?>
<!doctype html>
<html class="no-js">
<head>
  <meta charset="utf-8">
              ...
              <td>
                <div class="am-form-group search_input none-length">
                    ...
                    <select name="TubulationID">
                        ...
                        <?php if(session('user_base_info.institution_level')==1){;foreach($instLst as $k10 => $v10){ if($v10['level'] !=0 ){;                                 if($tenantOption != array()){
                        ...
                        <?php }}}elseif(session('user_base_info.institution_level')==2){; foreach($instLst as $k12 => $v12){ ;                                 if($tenantOption != array()){
...
<form  id="TenantForm" class="am-form" data-am-validator style="display:none;margin-top:1.6rem;">
	  ...
	  <fieldset id="InputForm" style="width:780px;">
		...
		<div class="am-u-md-6">
            ...
            <img class="am-form-group am-u-md-12" id="IDCardFace" style="width:312px;height:150px;float:left;">
		...
		<div class="am-u-md-6">
            ...
            <img class="am-form-group am-u-md-12" id="IDCardReverse" style="width:312px;height:150px;float:left;">
...
<form id="tenantModifyForm" class="am-form" data-am-validator style="display:none;margin-top:1.6rem;">
	  ...
	  <fieldset id="InputForm" style="width:780px;">
		...
		<div class="am-u-md-6">
            ...
            <img class="am-form-group am-u-md-12" id="IDCardFaceM" style="width:312px;height:150px;float:left;">
		...
		<div class="am-u-md-6">
			...
			<div class="am-form-group am-u-md-12">
                ...
                <div class="am-form-group am-form-file am-u-md-8">
                    <i class="am-icon-cloud-upload"></i> 选择要上传的文件
                    <input type="file" name="IDCardReverseM" id="imgDownM" multiple>
                </div>
            </div>
            <img class="am-form-group am-u-md-12" id="IDCardReverseM" style="width:312px;height:150px;float:left;">
