<?php if (!defined('THINK_PATH')) exit(); /*a:8:{s:71:"/usr/share/nginx/publichouse/application/ph/view/tenant_info/index.html";i:1563009962;s:60:"/usr/share/nginx/publichouse/application/ph/view/layout.html";i:1573559825;s:41:"application/ph/view/tenant_info/form.html";i:1563009962;s:43:"application/ph/view/tenant_info/detail.html";i:1562125654;s:43:"application/ph/view/tenant_info/modify.html";i:1563009962;s:43:"application/ph/view/notice/notice_info.html";i:1528342025;s:42:"application/ph/view/index/second_menu.html";i:1531059200;s:38:"application/ph/view/index/version.html";i:1578586810;}*/ ?>
<!doctype html>
<html class="no-js">
<head>
  <meta charset="utf-8">
              ...
              <?php } ; ?>
                ...
                <td class="dong_none">
                    ...
                    <?php
                     ...
                     ?>
                        <input name="TenantNumber" type="text" class="am-form-field" value="<?php echo $TenantNumber; ?>">
                    </div>
                </td>  
                  <td>
            				<div class="am-input-group am-input-group-sm">
	  ...
	  <fieldset id="InputForm" style="width:780px;">
		...
		<div class="am-u-md-6">
           ...
           <div class="am-u-md-12 j-upload">
			<div class="am-form-group am-u-md-12">
                <label for="imgUp" class="label_style" style="width:72px;">身份证正面：</label>
                <div class="am-form-group am-form-file am-u-md-8">
                    <i class="am-icon-cloud-upload"></i> 选择要上传的文件
                    <input type="file" name="IDCardFace" id="imgUp" multiple>
                </div>
				<div class="j-upload-img">
				  <img class="am-form-group am-u-md-12" id="IDCardFace" style="width:312px;height:150px;float:left;" src="/public/static/gf/icons/noimg.png">
		...
		<div class="am-u-md-6">
           ...
           <div class="am-u-md-12 j-upload">
			<div class="am-form-group am-u-md-12">
                <label for="imgDown" class="label_style" style="width:72px;">身份证反面：</label>
                <div class="am-form-group am-form-file am-u-md-8">
                    <i class="am-icon-cloud-upload"></i> 选择要上传的文件
                    <input type="file" name="IDCardReverse" id="imgDown" multiple>
                </div>
				<div class="j-upload-img">
				  <img class="am-form-group am-u-md-12" id="IDCardReverse" style="width:312px;height:150px;float:left;" src="/public/static/gf/icons/noimg.png">
				  <i  class="img_close j-hide"></i>
				</div>
            </div>
         </div>
		...
		<div class="am-u-md-6">
			...
			<div class="am-form-group am-u-md-12">
			  ...
			  <div class="am-u-md-8" style="float:left;">
					<p class="detail_p_style" id="TenantTel"></p>
			...
			<div class="am-form-group am-u-md-12">
			  ...
			  <div  class="am-u-md-8" style="float:left;">
					<p class="detail_p_style" id="TenantAge"></p>
			  </div>
			</div>
			...
			<div class="am-form-group am-u-md-12">
                <label class="label_style" style="width:72px;">身份证正面：</label>
            </div>
            <img class="am-form-group am-u-md-12" id="IDCardFaceDetail" style="width:312px;height:150px;float:left;">
		</div>
...
<!--左右分割-->		
		...
		<div class="am-u-md-6">
			<div class="am-form-group am-u-md-12">
				...
				<div class="am-u-md-8">
					<p class="detail_p_style" id="TenantName"></p>
				</div>
			</div>
			<div class="am-form-group am-u-md-12">
			  <label for="doc-select-5" class="label_style">性别：</label>
			  <div class="am-u-md-8" style="float:left;">
					<p class="detail_p_style" id="TenantSex"></p>
			  </div>
			</div>
			<div class="am-form-group am-u-md-12">
			  <label for="doc-select-5" class="label_style">余额：</label>
			  <div class="am-u-md-8" style="float:left;">
					<p class="detail_p_style" id="TenantBalance"></p>
			  </div>
			</div>
			<div class="am-form-group am-u-md-12">
			  <label for="doc-select-5" class="label_style">QQ号：</label>
			  <div class="am-u-md-8" style="float:left;">
					<p class="detail_p_style" id="TenantQQ"></p>
			  </div>
			</div>
			...
			<div class="am-form-group am-u-md-12">
				...
				<div class="am-u-md-8">
					<p class="detail_p_style" id="BankName"></p>
				</div>
			</div>
			<div class="am-form-group am-u-md-12">
				<label for="doc-vld-email-2" class="label_style">诚信值：</label>
				<div class="am-u-md-8">
					<p class="detail_p_style" id="TenantValue"></p>
				</div>
			</div>
			<div class="am-form-group am-u-md-12">
			  <label for="doc-select-7" class="label_style">登记机构：</label>
			  <div class="am-u-md-8" style="float:left;">
					<p class="detail_p_style" id="InstitutionName"></p>
				</div>
			</div>
			<div class="am-form-group am-u-md-12">
			  <label for="doc-select-7" class="label_style">登记时间：</label>
			  <div class="am-u-md-8" style="float:left;">
					<p class="detail_p_style" id="CreateTime"></p>
			  </div>
			</div>
			
			<div class="am-form-group am-u-md-12">
                <label class="label_style" style="width:72px;">身份证反面：</label>
            </div>
            <img class="am-form-group am-u-md-12" id="IDCardReverseDetail" style="width:312px;height:150px;float:left;">
...
<form id="tenantModifyForm" class="am-form" data-am-validator style="display:none;margin-top:1.6rem;">
	  ...
	  <fieldset id="InputForm" style="width:780px;">
		...
		<div class="am-u-md-6">
           ...
           <div class="am-u-md-12 j-upload">
			<div class="am-form-group am-u-md-12">
                <label for="imgUpM" class="label_style" style="width:72px;">身份证正面：</label>
                <div class="am-form-group am-form-file am-u-md-8">
                    <i class="am-icon-cloud-upload"></i> 选择要上传的文件
                    <input type="file" name="IDCardFace" id="imgUpM" multiple>
				    <input type="hidden" name="IDCardFaceM" id="editIDCardFaceHidden" class="j-edit" value="" >
                </div>
            </div>
			<div class="j-upload-img">
			  <img class="am-form-group am-u-md-12" id="IDCardFaceM" style="width:312px;height:150px;float:left;" src="/public/static/gf/icons/noimg.png">
			  <i  class="img_close j-hide"></i>
			</div>
         </div>
		</div>
		...
		<div class="am-u-md-6">
			<div class="am-form-group am-u-md-12">
			  <label class="label_style">租户姓名：</label>
				<div class="am-u-md-8">
					<input type="text" <?php if(session('user_base_info.institution_level') ==3): ?>readonly<?php endif; ?> name="TenantName" id="TenantNam" placeholder="租户姓名" required/>
				</div>
				<i style="font-style: normal; color:red; vertical-align: middle;">*</i>
			</div>
			<div class="am-form-group am-u-md-12">
           ...
           <div class="am-u-md-12 j-upload">
			<div class="am-form-group am-u-md-12">
                <label for="imgDownM" class="label_style" style="width:72px;">身份证反面：</label>
                <div class="am-form-group am-form-file am-u-md-8">
                    <i class="am-icon-cloud-upload"></i> 选择要上传的文件
                    <input type="file" name="IDCardReverse" id="imgDownM" multiple>
						<input type="hidden" name="IDCardReverseM" id="editIDCardReverseMHidden" class="j-edit" value="" >
                </div>
            </div>
			<div class="j-upload-img">
			  <img class="am-form-group am-u-md-12" id="IDCardReverseM" style="width:312px;height:150px;float:left;" src="/public/static/gf/icons/noimg.png">
			  <i  class="img_close j-hide"></i>
			</div>
           </div>
		</div>
...
<script src="/public/static/gf/js/require.js" data-main="/public/static/gf/viewJs/tenant_form.js?v=<?php echo $version; ?>"></script>
