<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:60:"D:\phpStudy\WWW\gf/application/user\view\publics\signin.html";i:1502849331;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    ...
    <div id="center-div">
        <div id="main-div">
            ...
            <div id="tel-part" hidden="hidden">
                ...
                <div id="" class="">
                    <img id="vertical-bar-code" class="img-margin" src="/public/static/user/images/code.png"><span class="vertical-bar">|</span><input id="code" placeholder="验证码" maxlength="6" class="edging code1" type="text" name=""><button id="btn-code">发送验证码</button><div class="tel-hr"></div>
                </div>
            ...
            <div id="name-part">
                <div id="" class="">
                    <img id="vertical-bar-user" class="img-margin" src="/public/static/user/images/user.png"><span class="vertical-bar">|</span><input id="UserName" placeholder="输入账号" maxlength="100" class="edging" type="text" name=""><div class="tel-hr"></div>
                </div>
                <div id="" class="">
                ...
                <div id="" class="">
                    <img id="vertical-bar-code2" class="img-margin" src="/public/static/user/images/code.png"><span class="vertical-bar">|</span><input id="yzm" placeholder="验证码" maxlength="6" class="edging code2" type="text" name="">
