<?php if (!defined('THINK_PATH')) exit(); /*a:8:{s:71:"/usr/share/nginx/publichouse/application/ph/view/role_manage/index.html";i:1560686457;s:60:"/usr/share/nginx/publichouse/application/ph/view/layout.html";i:1573559825;s:41:"application/ph/view/role_manage/form.html";i:1528342025;s:43:"application/ph/view/role_manage/modify.html";i:1528342025;s:47:"application/ph/view/role_manage/permission.html";i:1528342025;s:43:"application/ph/view/notice/notice_info.html";i:1528342025;s:42:"application/ph/view/index/second_menu.html";i:1531059200;s:38:"application/ph/view/index/version.html";i:1578586810;}*/ ?>
<!doctype html>
<html class="no-js">
<head>
  <meta charset="utf-8">
...
<div class="admin-content am-print-hide" style="display:none;"></div>
  ...
  <div class="admin-content">
    <div class="am-cf am-padding">
      <div class="am-fl am-cf"><small class="am-text-sm">权限管理</small> > <small class="am-text-primary">角色管理</small></div>
    </div>
      ...
      <div class="am-u-sm-12 am-u-md-6">
        <div class="am-btn-toolbar">
          <div class="am-btn-group-xs">
              <?php if(in_array(214,$threeMenu)){ ; ?>
              <button type="button" id="addRole" class="am-btn d-btn-1188F0 am-radius"><span class="am-icon-plus"></span> 新增角色</button>
              <?php }; if(in_array(215,$threeMenu)){ ; ?>
              <button type="button" id="reviseRole" class="am-btn d-btn-1188F0 am-radius"><span class="am-icon-edit"></span> 修改角色</button>
              <?php }; if(in_array(216,$threeMenu)){ ; ?>
              <button type="button" id="deleteRole" class="am-btn d-btn-1188F0 am-radius"><span class="am-icon-trash-o"></span>  删除角色</button>
              <?php }; if(in_array(219,$threeMenu)){ ; ?>
              <button type="button" id="permission" class="am-btn d-btn-1188F0 am-radius"><span class="am-icon-share"></span> 权限分配</button>
              <?php }; ?>
          </div>
        </div>
      </div>
    ...
    <div class="am-g">
      <div class="am-u-sm-12">
            ...
            <thead>
              <tr>
                  <th class="table-check"></th>
          				...
          				<th class="table-author am-hide-sm-only">是否为岗位</th>
          				<th class="table-date am-hide-sm-only">有效性</th>
              </tr>
          </thead>
          <tbody>

          <?php foreach($roleLst as $k => $v){ ;?>
            ...
            <tr class="check001">
                ...
                <td><?php echo ++$k; ?></td>
                <td><?php echo $v['id']; ?></td>
                <td class="am-hide-sm-only"><?php echo $v['RoleName']; ?></td>
                <td class="am-hide-sm-only"><?php echo $v['Ifstation']; ?></td>
		...
		<div class="am-cf">
		  共<?php echo $roleLstObj->total(); ?>条记录
		  <div class="am-fr">
              <?php echo $roleLstObj->render(); ?>
		  </div>
		</div>
      </div>
    </div>
  </div>
  <form id="RoleForm" class="am-form" data-am-validator style="display:none;margin-top:1.6rem;">
	  <fieldset >
		<!--<legend>添加楼栋</legend>-->
		<div class="am-u-sm-12">
<!-- 			<div class="am-form-group am-u-sm-12">
			  <label for="doc-vld-email-2" class="label_style">角色编号：</label>
			  <div class="am-u-sm-8">
				<input type="text" name="id" id="doc-vld-email-2" placeholder="角色编号" required/>
			  </div>
			</div> -->

			<div class="am-form-group am-u-sm-12">
				<label for="doc-vld-email-2" class="label_style">角色名称：</label>
				<div class="am-u-sm-8">
					<input type="text" name="RoleName" id="doc-vld-email-3" placeholder="角色名称" required/>
				</div>
			</div>

			<div class="am-form-group am-u-sm-12">
			  <label for="doc-select-8" class="label_style">是否为岗位</label>
				<div class="am-u-sm-8">
					<label class="am-radio-inline">
						<input type="radio"  value="1" name="Ifstation" checked="checked" required>是
					</label>
					<label class="am-radio-inline">
						<input type="radio" value="0" name="Ifstation"> 否
					</label>
				</div>
			</div>				
...
<!-- 		<div class="am-u-sm-12" style="text-align:center;margin-top:2rem;">
  ...
  <form id="RoleModifyForm" class="am-form" data-am-validator style="display:none;margin-top:1.6rem;">
	  ...
	  <fieldset>
		...
		<div class="am-u-sm-12">
			<div class="am-form-group am-u-sm-12">
			  <label for="doc-vld-email-2" class="label_style">角色编号：</label>
			  <div class="am-u-sm-8">
				<input type="text" name="id" onfocus=this.blur() id="id" placeholder="角色编号" required/>
			  </div>
			</div>
			...
			<div class="am-form-group am-u-sm-12">
				<label for="doc-vld-email-2" class="label_style">角色名称：</label>
				<div class="am-u-sm-8">
					<input type="text" name="RoleName" id="RoleName" placeholder="角色名称" required/>
				</div>
			</div>
...
<!-- 		<div class="am-u-sm-12" style="text-align:center;margin-top:2rem;">
  ...
  <form id="permissionForm" class="am-form" style="display:none;margin-top:1.6rem;">
    ...
    <fieldset style="width:580px;">
        <div class="am-panel-group" id="accordion">
            ...
            <?php foreach($treeMenu as $k1 => $v1){ if($v1['Level'] == 1){ ; ?>
            <div class="am-panel am-panel-default">
                <div class="am-panel-hd">
                    <h4 class="am-panel-title" data-am-collapse="{parent: '#accordion', target: '#do-not-say-<?php echo $v1['id']; ?>'}">
                    	<input name="id[]" value="<?php echo $v1['id']; ?>" type="checkbox" hidden />
                        <?php echo $v1['Title']; ?>
                    </h4>
                </div>
                <div id="do-not-say-<?php echo $v1['id']; ?>" class="am-panel-collapse am-collapse <?php if($k1==0){echo 'am-in';};?>">
                    <?php foreach($treeMenu as $k2 => $v2){ if($v2['pid'] == $v1['id']){ ; ?>
                    <div class="am-panel-bd am-g second_level">
                        <h3><input class="FatherName" name="id[]" type="checkbox" value="<?php echo $v2['id']; ?>"><?php echo $v2['Title']; ?></h3>
                        <!-- <hr data-am-widget="divider" style="" class="am-divider am-divider-default"/> -->
                        <ul class="am-u-sm-12">
                            <?php foreach($treeMenu as $k3 => $v3){ if($v3['pid'] == $v2['id']){ ;?>
                                <li class="am-u-sm-6 li_style"><input name="id[]" type="checkbox" value="<?php echo $v3['id']; ?>"/>
                                    <label>
                                        <?php echo $v3['Title']; ?>
                                    </label>
                                </li>
...
<script type="text/javascript" src="/public/static/gf/viewJs/role_manage.js?v=<?php echo $version; ?>"></script>
