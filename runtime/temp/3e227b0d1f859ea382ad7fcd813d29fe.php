<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:75:"/usr/share/nginx/publichouse/application/ph/view/rent_cut_report/index.html";i:1528342025;s:60:"/usr/share/nginx/publichouse/application/ph/view/layout.html";i:1534760328;s:45:"application/ph/view/form/rent_cut_report.html";i:1528342025;s:43:"application/ph/view/notice/notice_info.html";i:1528342025;s:42:"application/ph/view/index/second_menu.html";i:1531059200;s:38:"application/ph/view/index/version.html";i:1533542784;}*/ ?>
<!doctype html>
<html class="no-js">
<head>
  <meta charset="utf-8">
            ...
            <div class="am-u-md-12">
                ...
                <div class="am-u-md-2">
                    ...
                    <select name="TubulationID" id="doc-select-2">
                        ...
                        <?php if(session('user_base_info.institution_level')==1){;foreach($instLst as $k10 => $v10){ if($v10['level'] !=0 ){;                                 if($rentcutOption != array()){
                        ...
                        <?php }}}elseif(session('user_base_info.institution_level')==2){; foreach($instLst as $k12 => $v12){ ;                                 if($rentcutOption != array()){
