<?php if (!defined('THINK_PATH')) exit(); /*a:11:{s:70:"/usr/share/nginx/publichouse/application/ph/view/house_info/index.html";i:1564988985;s:60:"/usr/share/nginx/publichouse/application/ph/view/layout.html";i:1573559825;s:42:"application/ph/view/house_info/detail.html";i:1572706546;s:40:"application/ph/view/house_info/form.html";i:1563009962;s:42:"application/ph/view/house_info/modify.html";i:1574151644;s:44:"application/ph/view/house_info/RentForm.html";i:1566211566;s:45:"application/ph/view/house_info/RentFormM.html";i:1566211566;s:44:"application/ph/view/house_info/beInDebt.html";i:1528342025;s:43:"application/ph/view/notice/notice_info.html";i:1528342025;s:42:"application/ph/view/index/second_menu.html";i:1531059200;s:38:"application/ph/view/index/version.html";i:1578586810;}*/ ?>
<!doctype html>
<html class="no-js">
<head>
  <meta charset="utf-8">
                    ...
                    <tr class="am-form-group am-form-inline am-form">
                        ...
                        <td>
                            <div class="am-input-group am-input-group-sm">
                                ...
                                ?>
                                <input style="width:130px;" name="HouseID" type="text" class="am-form-field" value="<?php echo $HouseID; ?>">
                            </div>
                        </td>
                        ...
                        <td>
                            <div class="am-input-group am-input-group-sm">
                                <?php
                                 ...
                                 ?>
                                <input style="width:120px;" name="BanAddress" type="text" class="am-form-field" value="<?php echo $BanAddress; ?>">
                            </div>
                        </td>
                        <td>
                            <div class="am-input-group am-input-group-sm">
            ...
            <td>
                <div class="am-form-group search_input">
                    <select name="IfSuspend">
                        ...
                        <option value="1" <?php echo $selectDiff; ?>>是</option>
                        <option value="0" <?php echo $selectDiffs; ?>>否</option>
                    ...
                    <select name="IfEmpty">
                        ...
                        <td class="dong_none">
                            <?php
                                ...
                                ?>
                            <div style="width:120px;"><input style="width:50px;display:inline-block" name="HousePrerent" type="text" class="am-form-field" value="<?php echo $HousePrerent; ?>"> <?php echo $HousePrerentSum; ?></div>
                        </td>
                        <td>
                            <div style="width:50px;"><?php echo $ApprovedRentSum; ?></div>
                        </td>
                        <td>
                ...
                <tr class="check001" <?php if($v1['IfSuspend'] === '是'): ?>style="color:#9b9b9b;"<?php endif; ?>>
                    <td>
                    ...
                    <td class="am-hide-sm-only" <?php if($v1['IfSuspend'] === '是'): ?>style="color:#9b9b9b;"<?php elseif(($v1['UseNature'] == '住宅') && $v1['HousePrerent'] != $v1['ApprovedRent']): ?>style="color:red;" <?php endif; ?>><?php echo $v1['ApprovedRent']; ?></td>
                    <td class="dong_none"><?php echo ($v1['HousePrerent'] + $v1['PumpCost'] + $v1['DiffRent']); ?></td>
...
<div id="houseDetail" class="am-form" style="display:none;margin-top:1.6rem;">
	  ...
	  <fieldset >
		...
		<!-- 	<div class="am-form-group am-u-md-12">
			...
			<div class="am-form-group am-u-md-12">
			  <label for="doc-select-8" class="label_style" style="width:80px;">绑定楼栋：</label>
			  <div class="am-u-md-8" style="float:left;">
				 <ul class="j-storied" id="j-storied">
	...
	<fieldset style="width:780px;">
		...
		<div class="am-u-md-6">
			<div class="am-form-group am-u-md-12">
				...
				<div class="am-u-md-8">
					<input type="text" name="HouseID" readonly id="HouseI" onfocus=this.blur() placeholder="" required/>
				</div>
			</div>
			<div class="am-form-group am-u-md-12">
				<label class="label_style">使用性质：</label>
				<div class="am-u-md-8" style="float:left;">
					<select name="UseNature" disabled id="UseNature" >
						<option  value="" style="display:none">请选择</option>
						<?php foreach($useNatureLst as $k5 =>$v5){ ;?>
						<option value="<?php echo $v5['id']; ?>"><?php echo $v5['UseNature'];?></option>
						<?php }; ?>
			...
			<div class="am-form-group am-u-md-12">
				<label class="label_style">门牌号码：</label>
				<div class="am-u-md-8">
					<input type="text" name="DoorID" readonly  id="DoorI" placeholder="" required/>
				</div>
			</div>
...
<!-- 			<div class="am-form-group am-u-md-12">
			...
			<div class="am-form-group am-u-md-12">
				...
				<div class="am-u-md-8">
					<input type="text" name="OldOprice" readonly  id="OldOpric" placeholder="" required/>
				</div>
			</div>
			...
			<div class="am-form-group am-u-md-12">
			  	<label class="label_style">建筑面积：</label>
				<div class="am-u-md-8">
					<input type="text" name="HouseArea" readonly  id="HouseAre" placeholder="" required/>
				</div>
				<i style="font-style: normal; color:red; vertical-align: middle;">*</i>
			</div>			
			<!-- <div class="am-form-group am-u-md-12">
		...
		<div class="am-u-md-6">
			...
			<div class="am-form-group am-u-md-12">
				<label class="label_style">楼栋编号：</label>
				<div class="am-u-md-8">
					<input type="text" name="BanID" readonly  id="BanI" placeholder="" required/>
				</div>
				<i style="font-style: normal; color:red; vertical-align: middle;">*</i>
			</div>
			...
			<div class="am-form-group am-u-md-12">
				<label class="label_style">套内建面：</label>
				<div class="am-u-md-8">
					<input type="text" name="ComprisingArea" readonly  id="ComprisingAre" placeholder="" required/>
				</div>
			</div>
			<div class="am-form-group am-u-md-12">
				<label class="label_style">租户ID：</label>
				<div class="am-u-md-8">
					<input type="text" name="TenantID" disabled id="TenantI" placeholder="" required/>
				</div>
			</div>
			<div class="am-form-group am-u-md-12">
				<label class="label_style">住改非：</label>
				<div class="am-u-md-8">
					<label class="am-radio-inline">
						<input type="radio" disabled   value="1" name="NonliveIf" required> 是
					</label>
					<label class="am-radio-inline">
						<input type="radio" disabled  value="0" name="NonliveIf"> 否
					</label>
				</div>
			</div>
    ...
    <div class="am-u-md-12 addP">
    	...
    	<div class="am-u-md-12">
    		<div class="am-u-md-3">
				...
				<div><span class="w200">空间1至1.7米(5㎡以下)</span><span class="w50 mr"><input type="text"  width="100%" class="RentBelowd" name='AddRent[RentBelow]' readonly="readonly"/></span>个</div>
				<div><span class="w200">阁楼(含1.7米)(5㎡以上)</span><span class="w50 mr"><input type="text"  width="100%" class="RentMored" name='AddRent[RentMore]' readonly="readonly" /></span>个</div>
				<input type="hidden"  width="100%" class="RentMored" name='AddRent[RentMore]' readonly="readonly" />
    		...
    		<div class="am-u-md-6">
    			<div class="am-u-md-12">
    				...
    				<div class="am-u-md-6"><span class="w100">规定租金：</span><span class="w90 mr"><input type="text" class="RentPriced" name="AddRent[TypeF][RPrice]" readonly="readonly"></span></div>
    			</div>
    			<div class="am-u-md-12">
    				<div class="am-u-md-6"><span class="w100">产别：</span>
    				<span class="w90 mr">
    					<select name="AddRent[TypeS][OwnerType]" class="ROwnerTypeS" readonly="readonly">
							<option value="0">请选择</option>
							
						</select>
    				</span>
    				</div>
    				<div class="am-u-md-6"><span class="w100">规定租金：</span><span class="w90 mr"><input type="text" class="RentPriced" name="AddRent[TypeS][RPrice]" readonly="readonly"></span></div>
    			</div>
    			<div class="am-u-md-12">
    				<div class="am-u-md-6"><span class="w100">计算租金：</span><span class="w90 RentApproved" name="StipulateR"></span></div>
    				<div class="am-u-md-6">
						<span class="w100">租差：</span><span class="w90 mr"><input type="text" class="diffRentd" name='AddRent[DiffRent]' readonly="readonly"></span>
					</div>
    			</div>
				...
				<div class="am-u-md-12">
					...
					<div class="am-u-md-6">
						<span class="w100">协议租金：</span><span class="w90 mr"><input type="text" class="agreementRentd" name='AddRent[ProtocolRent]' readonly="readonly"></span>
					</div>
				</div>
				<div class="am-u-md-12">
					<div class="am-u-md-6">
						<span class="w100">泵费：</span><span class="w90 mr"><input type="text" class="RentPumpd" name='AddRent[PumpPrice]' readonly="readonly"></span>
					</div>
				</div>
				<div class="am-u-md-12">
					<div class="am-u-md-6">
...
<script type="text/javascript" src="/public/static/gf/viewJs/house_form.js?v=<?php echo $version; ?>"></script>
