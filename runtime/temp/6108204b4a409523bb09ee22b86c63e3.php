<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:62:"D:\phpStudy\WWW\ph/application/ph\view\repair_apply\index.html";i:1523846105;s:50:"D:\phpStudy\WWW\ph/application/ph\view\layout.html";i:1523846105;s:44:"application/ph/view/repair_apply/detail.html";i:1523846105;s:47:"application/ph/view/form/small_repair_form.html";i:1523846105;s:43:"application/ph/view/notice/notice_info.html";i:1523846106;s:42:"application/ph/view/index/second_menu.html";i:1523846106;}*/ ?>
<!doctype html>
<html class="no-js">
<head>
  <meta charset="utf-8">
...
<div class="am-cf admin-main">
  ...
  <div class="admin-content ">
    <div class="am-cf am-padding">
      <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">维修管理</strong> / <small>维修申请</small></div>
    </div>
      ...
      <div class="am-u-sm-12 am-u-md-6">
        <div class="am-btn-toolbar">
          <div class="am-btn-group am-btn-group-xs">
            ...
            <button type="button" id="addSRepair" class="am-btn am-btn-default"><span class="am-icon-plus"></span> 小修申请</button>
              <?php }; if(in_array(46,$threeMenu)){ ; ?>
            <button type="button" id="addMRepair" class="am-btn am-btn-default addRepair" value="2"><span class="am-icon-save"></span> 中修申请</button>
              <?php }; if(in_array(47,$threeMenu)){ ; ?>
            <button type="button" id="addSafetyRepair" class="am-btn am-btn-default addRepair" value="3"><span class="am-icon-trash-o"></span> 排危申请</button>
              <?php }; if(in_array(47,$threeMenu)){ ; ?>
            <button type="button" class="am-btn am-btn-default addRepair" value="4"><span class="am-icon-trash-o"></span> 电器线隐患整治申请</button>
              <?php }; ?>
          </div>
        </div>
      </div>
...
<!--                           <select name="DamageGrade">
              ...
              <td>
                ...
                <a class="am-btn am-btn-xs am-text-secondary" style="border:1px solid #e6e6e6;background:#FFF;" href="/ph/RepairApply/index.html">重置</a>
              </td>
            </tr>
          </form>
		<!---查询-->
            ...
            <tr>
                ...
                <td>
                    <div class="am-btn-group am-btn-group-xs">
                      ...
                      <button class="am-btn am-btn-default am-btn-xs am-text-secondary am-hide-sm-only structureBtn" value="">修改</button>
