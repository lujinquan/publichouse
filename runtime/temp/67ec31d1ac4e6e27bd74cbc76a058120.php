<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:72:"/usr/share/nginx/publichouse/application/ph/view/rent_payable/index.html";i:1560686457;s:60:"/usr/share/nginx/publichouse/application/ph/view/layout.html";i:1573559825;s:43:"application/ph/view/notice/notice_info.html";i:1528342025;s:42:"application/ph/view/index/second_menu.html";i:1531059200;s:38:"application/ph/view/index/version.html";i:1578586810;}*/ ?>
<!doctype html>
<html class="no-js">
<head>
  <meta charset="utf-8">
              ...
              <td>
                ...
                <div class="am-form-group search_input">
                    <select name="DiffRent">
                        ...
                        <option value="1" <?php echo $selectDiff; ?>>有</option>
                        <option value="0" <?php echo $selectDiffs; ?>>无</option>
                ...
                <div class="am-form-group search_input">
                    <select name="PumpCost">
                        ...
                        <option value="1" <?php echo $selectPump; ?>>有</option>
                        <option value="0" <?php echo $selectPumps; ?>>无</option>
                ...
                <div class="am-form-group search_input">
                    <select name="CutRent">
                        ...
                        <option value="1" <?php echo $selectCut; ?>>有</option>
                        <option value="0" <?php echo $selectCuts; ?>>无</option>
                       
                    </select>
                </div></td>
                <td><div style="width:50px;"><?php echo $receiveRents; ?></div></td>
...
<script type="text/javascript" src="/public/static/gf/viewJs/rent_payable.js?v=<?php echo $version; ?>"></script>
