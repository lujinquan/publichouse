<?php if (!defined('THINK_PATH')) exit(); /*a:7:{s:70:"/usr/share/nginx/publichouse/application/ph/view/org_manage/index.html";i:1560686457;s:60:"/usr/share/nginx/publichouse/application/ph/view/layout.html";i:1573559825;s:40:"application/ph/view/org_manage/form.html";i:1528342025;s:42:"application/ph/view/org_manage/modify.html";i:1528342025;s:43:"application/ph/view/notice/notice_info.html";i:1528342025;s:42:"application/ph/view/index/second_menu.html";i:1531059200;s:38:"application/ph/view/index/version.html";i:1578586810;}*/ ?>
<!doctype html>
<html class="no-js">
<head>
  <meta charset="utf-8">
...
<div class="admin-content am-print-hide" style="display:none;"></div>
  ...
  <div class="admin-content">
    <div class="am-cf am-padding">
      <div class="am-fl am-cf"><small class="am-text-sm">权限管理</small> > <small class="am-text-primary">机构管理</small></div>
    </div>
      ...
      <div class="am-u-sm-12 am-u-md-6">
        <div class="am-btn-toolbar">
          <div class="am-btn-group-xs">
              <?php if(in_array(208,$threeMenu)){ ; ?>
              <button type="button" id="addOrg" class="am-btn d-btn-1188F0 am-radius"><span class="am-icon-plus"></span> 新增机构</button>
              <?php }; if(in_array(209,$threeMenu)){ ; ?>
              <button type="button" id="reviseOrg" class="am-btn d-btn-1188F0 am-radius"><span class="am-icon-edit"></span> 修改机构</button>
              <?php }; if(in_array(210,$threeMenu)){ ; ?>
              <button type="button" id="deleteOrg" class="am-btn d-btn-1188F0 am-radius"><span class="am-icon-trash-o"></span>  删除机构</button>
              <?php }; ?>
          </div>
        </div>
      </div>
    ...
    <div class="am-g">
      <div class="am-u-sm-12">
		...
		<div class="am-cf">
		  共<?php echo $orgLstObj->total(); ?>条记录
		  <div class="am-fr">
              <div class="am-fr">
                  <?php echo $orgLstObj->render(); ?>
              </div>
		  </div>
		</div>
    </div>
  ...
  <form id="OrgForm" class="am-form" data-am-validator style="display:none;margin-top:1.6rem;">

	  <fieldset style="width:400px;">
		<!--<legend>添加楼栋</legend>-->
		<div class="am-u-sm-12">
			<!--<div class="am-form-group am-u-sm-12">-->
			  <!--<label for="doc-vld-email-2" class="label_style">机构编号：</label>-->
			  <!--<div class="am-u-sm-8">-->
				<!--<input type="text" name="TenantID" id="doc-vld-email-2" placeholder="租户编号" required/>-->
			  <!--</div>-->
			<!--</div>-->

			<div class="am-form-group am-u-sm-12">
				<label for="doc-vld-email-2" class="label_style">机构名称：</label>
				<div class="am-u-sm-8">
					<input type="text" name="Institution" id="doc-vld-email-3" placeholder="机构名称" required/>
				</div>
			</div>

			<div class="am-form-group am-u-md-12">
				<label for="doc-select-2" class="label_style">选择上级所属：</label>
				<div class="am-u-md-8" style="float:left;">
					<select name="id" id="doc-select-2" required>

						<option  value="" style="display:none">请选择</option>



							<?php  foreach($highOrg as $k11 => $v11){  ; ?>
...
<!-- 		<div class="am-u-sm-12" style="text-align:center;margin-top:2rem;">
  ...
  <form action="<?php echo url('TenantInfo/edit'); ?>" method="post" id="OrgModifyForm" class="am-form" data-am-validator style="display:none;margin-top:1.6rem;">
	  ...
	  <fieldset style="width:400px;">
		...
		<div class="am-u-sm-12">
			<div class="am-form-group am-u-sm-12">
				<label for="doc-vld-email-2" class="label_style">机构名称：</label>
				<div class="am-u-sm-8">
					<input type="text" name="Institution" id="Institution" placeholder="机构名称" required/>
				</div>
			</div>
...
<script type="text/javascript" src="/public/static/gf/viewJs/org_manage.js?v=<?php echo $version; ?>"></script>
