<?php if (!defined('THINK_PATH')) exit(); /*a:7:{s:54:"D:\phpStudy\WWW\ph/application/ph\view\room\index.html";i:1526715013;s:50:"D:\phpStudy\WWW\ph/application/ph\view\layout.html";i:1526635961;s:34:"application/ph/view/room/form.html";i:1523846105;s:36:"application/ph/view/room/detail.html";i:1523846105;s:36:"application/ph/view/room/modify.html";i:1523846105;s:43:"application/ph/view/notice/notice_info.html";i:1523846106;s:42:"application/ph/view/index/second_menu.html";i:1523846106;}*/ ?>
<!doctype html>
<html class="no-js">
<head>
  <meta charset="utf-8">
        ...
        <div class="am-u-sm-12 am-u-md-6">
            <div class="am-btn-toolbar">
                <div class="am-btn-group am-btn-group-xs">
                    ...
                    <button type="button" id="addRoom" class="am-btn am-btn-default"><span class="am-icon-plus"></span> 新增房间
                    </button>
                    <?php }; if(in_array(64,$threeMenu)){ ; ?>
                    <button type="button" id="reviseRoom" class="am-btn am-btn-default"><span
                            class="am-icon-edit"></span> 修改房间
                    </button>
                    <?php }; if(in_array(513,$threeMenu)){ ; ?>
                     <button type="button" id="deleteRoom" class="am-btn am-btn-default"><span
              ...
              <?php } ; ?>
                        ...
                        <td>
                            <div class="am-btn-group am-btn-group-xs" style="width:114px;">
                              ...
                              <a id="clearBanInfo" class="am-btn am-btn-xs am-text-secondary ABtn" href="/ph/Room/index"><span class="ResetIcon"></span>重置</a>
                            </div>
                        </td>
                    </tr>
                </form>
                ...
                <tr class="check001">
                    ...
                    <td>
                        <div class="am-btn-group am-btn-group-xs">
                            ...
                            <button class="am-btn am-btn-default am-btn-xs am-text-secondary details" value="<?php echo $v9['RoomID']; ?>"> 明细</button>
                            <?php }; ?>
                        </div>
                    </td>
                </tr>
