<?php if (!defined('THINK_PATH')) exit(); /*a:7:{s:71:"/usr/share/nginx/publichouse/application/ph/view/post_manage/index.html";i:1560686457;s:60:"/usr/share/nginx/publichouse/application/ph/view/layout.html";i:1573559825;s:41:"application/ph/view/post_manage/form.html";i:1528342025;s:43:"application/ph/view/post_manage/modify.html";i:1528342025;s:43:"application/ph/view/notice/notice_info.html";i:1528342025;s:42:"application/ph/view/index/second_menu.html";i:1531059200;s:38:"application/ph/view/index/version.html";i:1578586810;}*/ ?>
<!doctype html>
<html class="no-js">
<head>
  <meta charset="utf-8">
...
<div class="admin-content am-print-hide" style="display:none;"></div>
  ...
  <div class="admin-content">
    <div class="am-cf am-padding">
      <div class="am-fl am-cf"><small class="am-text-sm">权限管理</small> > <small class="am-text-primary">职务管理</small></div>
    </div>
      ...
      <div class="am-u-sm-12 am-u-md-6">
        <div class="am-btn-toolbar">
          <div class="am-btn-group-xs">
              <?php if(in_array(205,$threeMenu)){ ; ?>
              <button type="button" id="addPost" class="am-btn d-btn-1188F0 am-radius"><span class="am-icon-plus"></span> 新增职务</button>
              <?php }; if(in_array(206,$threeMenu)){ ; ?>
              <button type="button" id="revisePost" class="am-btn d-btn-1188F0 am-radius"><span class="am-icon-edit"></span> 修改职务</button>
              <?php }; if(in_array(207,$threeMenu)){ ; ?>
              <button type="button" id="deletePost" class="am-btn d-btn-1188F0 am-radius"><span class="am-icon-trash-o"></span> 删除职务</button>
              <?php }; ?>
          </div>
        </div>
      </div>
            ...
            <thead>
              <tr>
                <th class="table-check"></th>
        				...
        				<th class="table-title">职务编号</th>
        				<th class="table-type">职务名称</th>
        				<th class="table-author am-hide-sm-only">有效性</th>
<!-- 				<th class="table-set" style="width:220px;">操作</th> -->
              </tr>
          </thead>
          <tbody>

          <?php foreach( $postLst as $k => $v){ ;?>

            <tr class="check001">
                <td>
                  <span class="piaochecked">
                    <input class="checkId radioclass" name="choose" type="radio" value="<?php echo $v['PostID']; ?>" />
                  </span>
                  </td>
                <td><?php echo ++$k; ?></td>
                <td class="am-hide-sm-only"><?php echo $v['PostID']; ?></td>
                <td class="am-hide-sm-only"><?php echo $v['PostName']; ?></td>
                <td class="am-hide-sm-only"><?php echo $v['Status']; ?></td>
<!--               <td>
                <div class="am-btn-toolbar">
                  <div class="am-btn-group am-btn-group-xs">
                    <button class="am-btn am-btn-default am-btn-xs am-text-secondary details details_btn" value=""> 明细</button>
                  </div>
                </div>
              </td> -->
            </tr>
		...
		<div class="am-cf">
		  共<?php echo $postLstObj->total(); ?>条记录
		  <div class="am-fr">
           <?php echo $postLstObj->render(); ?>
		  </div>
		</div>
      </div>
    </div>
  </div>
  <form id="PostForm" class="am-form" data-am-validator style="display:none;margin-top:1.6rem;">

	  <fieldset style="width:400px;">
		<!--<legend>添加楼栋</legend>-->
		<div class="am-u-sm-12">
<!-- 			<div class="am-form-group am-u-sm-12">
			  <label for="doc-vld-email-2" class="label_style">职务编号：</label>
			  <div class="am-u-sm-8">
				<input type="text" name="PostID" id="doc-vld-email-2" placeholder="职务编号" required/>
			  </div>
			</div> -->

			<div class="am-form-group am-u-sm-12">
				<label for="doc-vld-email-2" class="label_style">职务名称：</label>
				<div class="am-u-sm-8">
					<input type="text" name="PostName" id="doc-vld-email-3" placeholder="职务名称" required/>
				</div>
			</div>

			<div class="am-form-group am-u-md-12">
				<label for="doc-select-8" style="float:left;">职务是否有效：</label>
				<div class="am-u-md-7">
  ...
  <form  id="PostModifyForm" class="am-form" data-am-validator style="display:none;margin-top:1.6rem;">
	  ...
	  <fieldset style="width:400px;">
		...
		<div class="am-u-sm-12">
			<div class="am-form-group am-u-sm-12">
			  <label for="doc-vld-email-2" class="label_style">职务编号：</label>
			  <div class="am-u-sm-8">
				<input type="text" name="PostID" onfocus=this.blur() id="PostI" placeholder="职务编号" required/>
			  </div>
			</div>
			<div class="am-form-group am-u-sm-12">
				<label for="doc-vld-email-2" class="label_style">职务名称：</label>
				<div class="am-u-sm-8">
					<input type="text" name="PostName" id="PostNam" placeholder="职务名称" required/>
				</div>
			</div>
			<div class="am-form-group am-u-md-12">
				<label for="doc-select-8" style="float:left;">职务是否有效：</label>
...
<script src="/public/static/gf/js/require.js" data-main="/public/static/gf/viewJs/post_manage.js?v=<?php echo $version; ?>"></script>
