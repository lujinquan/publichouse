<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:71:"/usr/share/nginx/publichouse/application/ph/view/user_record/index.html";i:1569117624;s:60:"/usr/share/nginx/publichouse/application/ph/view/layout.html";i:1573559825;s:47:"application/ph/view/user_audit/approveForm.html";i:1566211566;s:43:"application/ph/view/notice/notice_info.html";i:1528342025;s:42:"application/ph/view/index/second_menu.html";i:1531059200;s:38:"application/ph/view/index/version.html";i:1578586810;}*/ ?>
<!doctype html>
<html class="no-js">
<head>
  <meta charset="utf-8">
...
<div class="admin-content am-print-hide" style="display:none;"></div>
  ...
  <div class="admin-content">
    <div class="am-cf am-padding">
      <div class="am-fl am-cf"><small class="am-text-sm">使用权变更</small> > <small class="am-text-primary">使用权变更记录</small></div>
    </div>
          ...
          <table class="am-table am-table-striped am-table-hover table-main am-table-centered">
            <thead>
              <tr>
                ...
                <?php }; ?>
        				<th class="table-author am-hide-sm-only">转让形式</th>
            ...
            <tbody>
        		  <!--查询-->
                  <form action="<?php echo url('UserRecord/index'); ?>" method="post" id="queryForm">
                     ...
                     ?>
                          ...
                          <td>
                              <div class="am-btn-group am-btn-group-xs" style="width:114px;">
                                  ...
                                  <a id="clearUserApplyInfo" class="am-btn am-btn-xs am-text-primary ABtn" href="/ph/UserRecord/index.html"><span class="ResetIcon"></span>重置</a>
                              </div>
                          </td>
                      </tr>
                  </form>
