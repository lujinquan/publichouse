<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:75:"/usr/share/nginx/publichouse/application/ph/view/property_report/index.html";i:1586739937;s:60:"/usr/share/nginx/publichouse/application/ph/view/layout.html";i:1573559825;s:44:"application/ph/view/form/property_right.html";i:1568769712;s:43:"application/ph/view/notice/notice_info.html";i:1528342025;s:42:"application/ph/view/index/second_menu.html";i:1531059200;s:38:"application/ph/view/index/version.html";i:1578586810;}*/ ?>
<!doctype html>
<html class="no-js">
<head>
  <meta charset="utf-8">
...
<div class="admin-content">
    ...
    <div class="am-g">
        ...
        <form action="<?php echo url('PropertyReport/index'); ?>" method="post" class="am-form am-print-hide" style="margin-bottom:20px;padding-left:6px;">
            ...
            <div class="am-u-md-2">
                <input type="text" name="year" value="<?php echo $year; ?>" class="am-form-field" data-am-datepicker="{format: 'yyyy-mm', viewMode: 'months',minViewMode: 'months'}" id="property" placeholder="日历组件" data-am-datepicker readonly/>
            </div>
...
<table class="am-table am-table-bordered am-table-centered" id="PropertyForm">
        <thead>
            ...
            <tr>
                ...
                <td rowspan="1" colspan="6" class="am-text-middle">月度房增加<span style="padding: 0 5px"><?php echo $data[1][0]; ?></span>栋，建筑面积<span style="padding: 0 5px"></span><?php echo $data[1][1]; ?>㎡</td>
                <td rowspan="1" colspan="9" class="am-text-middle">月度房减少<span style="padding: 0 5px"><?php echo $data[1][2]; ?></span>栋，建筑面积<span style="padding: 0 5px"></span><?php echo $data[1][3]; ?>㎡</td>
            </tr>
            <tr>
