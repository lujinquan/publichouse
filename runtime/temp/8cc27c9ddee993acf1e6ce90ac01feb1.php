              ...
              <td>
                ...
                <td>
                    <div class="am-input-group am-input-group-sm" style="width:150px;">
                     ...
                     ?>
                      <input style="width:140px;" type="text" name="OrderDate" class="am-form-field" type="text" data-am-datepicker="{format: 'yyyy/mm', viewMode: 'years',minViewMode: 'months'}" value="<?php echo $OrderDate; ?>" placeholder="" data-am-datepicker readonly/>
                    </div>
                </td>
