<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:70:"/usr/share/nginx/publichouse/application/ph/view/rent_debit/index.html";i:1560686457;s:60:"/usr/share/nginx/publichouse/application/ph/view/layout.html";i:1573559825;s:42:"application/ph/view/rent_debit/detail.html";i:1562741293;s:43:"application/ph/view/notice/notice_info.html";i:1528342025;s:42:"application/ph/view/index/second_menu.html";i:1531059200;s:38:"application/ph/view/index/version.html";i:1578586810;}*/ ?>
<!doctype html>
<html class="no-js">
<head>
  <meta charset="utf-8">
...
<div class="admin-content am-print-hide" style="display:none;"></div>
              ...
              <td>
                ...
                <td>
                    <div class="am-input-group am-input-group-sm" style="width:80px;">
                     ...
                     ?>
                      <input style="width:80px;" type="text" name="OrderDate" class="am-form-field" type="text" data-am-datepicker="{format: 'yyyy/mm', viewMode: 'years',minViewMode: 'months'}" value="<?php echo $OrderDate; ?>" placeholder="" data-am-datepicker readonly/>
                    </div>
                </td>
                    ...
                    <div class="am-input-group am-input-group-sm" style="width:210px;">
                     ...
                     ?>
                        <div class="am-u-sm-6" style="padding:0;">
                          <input style="width:140px;" name="PaidableTime" value="<?php echo $PaidableTime; ?>" type="text" class="am-form-field" data-am-datepicker />
                        </div>
  ...
  <form id="details" class="am-form" style="display:none;margin-top:20px;">
	<div class="am-form-group am-u-sm-12">
		...
		<div class="am-form-group am-u-sm-6 am-u-end">
			<label>月租金：</label><label id="HousePrerent"></label>
		</div>
		<div class="am-form-group am-u-sm-6 am-u-end">
...
<script type="text/javascript" src="/public/static/gf/viewJs/rent_debit.js?v=<?php echo $version; ?>"></script>
