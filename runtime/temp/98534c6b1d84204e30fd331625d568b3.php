<?php if (!defined('THINK_PATH')) exit(); /*a:7:{s:66:"/usr/share/nginx/publichouse/application/ph/view/notice/index.html";i:1567470902;s:60:"/usr/share/nginx/publichouse/application/ph/view/layout.html";i:1573559825;s:38:"application/ph/view/notice/dialog.html";i:1554355829;s:38:"application/ph/view/notice/modify.html";i:1554355829;s:43:"application/ph/view/notice/notice_info.html";i:1528342025;s:42:"application/ph/view/index/second_menu.html";i:1531059200;s:38:"application/ph/view/index/version.html";i:1578586810;}*/ ?>
<!doctype html>
<html class="no-js">
<head>
  <meta charset="utf-8">
...
<!-- content start -->
<script type="text/javascript" charset="utf-8" src="/extend/ueditor/ueditor.config.js?v=<?php echo $version; ?>"></script>
<script type="text/javascript" charset="utf-8" src="/extend/ueditor/ueditor.all.js?v=<?php echo $version; ?>"></script>
<script type="text/javascript" charset="utf-8" src="/extend/ueditor/lang/zh-cn/zh-cn.js?v=<?php echo $version; ?>"></script>
        ...
        <table class="am-table am-table-striped am-table-hover table-main am-table-centered">
          ...
          <?php $k = 1; foreach($notice_list_data as $info){ ; ?>
            <tr class="check001">
                ...
                <td class="am-hide-sm-only" width="15%"><?php echo $info['UpdateTime']; ?></td>
                <td class="am-hide-sm-only" width="10%">
                    <?php switch($info['Institution']): case "4": ?>全部<?php break; case "2": ?>紫阳所<?php break; case "3": ?>粮道所<?php break; default: ?>全部
                    <?php endswitch; ?>
                </td>
                <td class="am-hide-sm-only">
                ...
                <td class="am-hide-sm-only" width="10%"><?php echo $info['Name']; ?></td>
            </tr>
          <?php }; ?>
...
<div id="dialog" style="display: none;margin: 20px;">
	...
	<div class="am-form-group am-u-md-12">
	    <label for="doc-select-8" style="float:left;">标题：</label>
		<div class="am-u-md-8">
			<input type="text" name="title" id="title" placeholder="" required/>
		</div>
	</div>
<!-- 	<div class="am-form-group am-u-md-12">
		<label for="doc-select-8" style="float:left;">状态：</label>
		<div class="am-u-md-8">
			<label class="am-radio-inline">
				<input type="radio"  value="1" name="IsTop" class="radio"> 置顶
			</label>
			<label class="am-radio-inline">
				<input type="radio" value="0" name="IsTop" class="radio" checked="checked"> 普通
			</label>
		</div>
	</div> -->
	<div class="am-form-group am-u-md-12">
	  <label for="doc-select-8" style="float:left;">状态：</label>
	  <div class="am-u-md-8">
		<select name="IsTop" id="istop" style="width:180px">
	...
	<div class="am-form-group am-u-md-12">
	  <label for="doc-select-8" style="float:left;">可见：</label>
	  <div class="am-u-md-8">
		<select name="InstitutionID" id="institution" style="width:180px">
	...
	<textarea id="editor" name="content" style="width:850px;height:570px;"></textarea>
</div>
...
<div id="modify_dialog" style="display: none;margin: 20px;">
	...
	<div class="am-form-group am-u-md-12">
	    <label for="doc-select-8" style="float:left;">标题：</label>
		<div class="am-u-md-8">
			<input type="text" name="modify_title" id="modify_title" placeholder="" required/>
		</div>
	</div>
<!-- 	<div class="am-form-group am-u-md-12">
		<label for="doc-select-8" style="float:left;">状态：</label>
		<div class="am-u-md-8">
			<label class="am-radio-inline">
				<input type="radio"  value="1" name="IsTop" class="radio" required> 置顶
			</label>
			<label class="am-radio-inline">
				<input type="radio" value="0" name="IsTop" class="radio" checked="checked" > 普通
			</label>
	...
	<div class="am-form-group am-u-md-12">
	  <label for="doc-select-8" style="float:left;">可见：</label>
	  <div class="am-u-md-8">
		<select name="InstitutionID" id="InstitutionID" style="width:180px">
			<option  value="" style="display:none">请选择</option>
			<option value="4">全部</option>
			<option value="2">紫阳所</option>
			<option value="3">粮道所</option>
	...
	<textarea id="modify_editor" name="content" style="width:850px;height:570px;"></textarea>
</div>
