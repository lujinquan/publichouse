<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:74:"/usr/share/nginx/publichouse/application/ph/view/old_month_rent/index.html";i:1560686457;s:60:"/usr/share/nginx/publichouse/application/ph/view/layout.html";i:1573559825;s:46:"application/ph/view/old_month_rent/detail.html";i:1566211566;s:43:"application/ph/view/notice/notice_info.html";i:1528342025;s:42:"application/ph/view/index/second_menu.html";i:1531059200;s:38:"application/ph/view/index/version.html";i:1578586810;}*/ ?>
<!doctype html>
<html class="no-js">
<head>
  <meta charset="utf-8">
    ...
    <div class="am-g">
        <div class="am-scrollable-horizontal">
            <table class="am-table am-table-striped am-table-hover table-main am-table-centered">
                ...
                <tbody>
                <!--查询-->
                <form id="queryForm" action="<?php echo url('OldMonthRent/index'); ?>" method="post">
                    <tr class="am-form-group am-form-inline am-form">
                        ...
                        <td>
                            <div class="am-input-group am-input-group-sm" style="width:80px;">
                                <?php
                                $PayMonth = $oldRentOption?$oldRentOption['PayMonth']:'';
                                ?>
                                <input type="text" id="timeYear" name="PayMonth" value="<?php echo $PayMonth; ?>" class="am-u-md-8" data-am-datepicker="{format: 'yyyy/mm', viewMode: 'years',minViewMode: 'months'}" placeholder="" data-am-datepicker readonly/>
                            </div>
                        </td>
                        <?php if(session('user_base_info.institution_level')!=3){ ;?>
                        <td>
            ...
            <?php foreach($oldRentLst as $oldk => $oldv){ ;?>
                <tr class="check001">
                  ...
                  <span class="piaochecked">
                      <input class="checkId radioclass" type="radio" name='choose' value="<?php echo $oldv['id']; ?>"/>
                  </span>
                    </td>
                    <td><?php echo $oldk+1; ?></td>
                    <td class="am-hide-sm-only"><?php echo $oldv['HouseID']; ?></td>
                    <td class="am-hide-sm-only"><?php echo $oldv['PayMonth']; ?></td>
                    <?php if(session('user_base_info.institution_level')!=3){ ;?>
...
<form id="oldCutForm" class="am-form" style="display:none;margin-top:20px;">
  ...
  <div class="am-form-group am-u-sm-12">
    ...
    <div class="am-form-group am-u-sm-8" style="padding:0;">
      <label>楼栋地址：</label><label id="BanAddress" class="label_content"></label>
    </div>
   ...
   <div class="am-form-group am-u-sm-12">
    ...
    <div class="am-form-group am-u-sm-4 am-u-end" data-am-validator>
      <input type="text" name="yaer" id="year" onfocus=this.blur() value="2017"/>
    </div>
  </div>
  <div class="am-form-group am-u-sm-12">
    <div class="am-form-group am-u-sm-2">
  ...
  <div class="am-form-group am-u-sm-12">
    ...
    <div class="am-form-group am-u-sm-4 am-u-end" data-am-validator>
      <input type="text" name="yaer" id="oldRentMonth" onfocus=this.blur() value="<?php echo date('Y-m',time()); ?>"  />
    </div>
  </div>
 ...
 <div id="DoldCutForm" class="am-form" style="display:none;margin-top:20px;">
  ...
  <div class="am-form-group am-u-sm-12">
    ...
    <div class="am-form-group am-u-sm-4" style="padding:0;">
      <label>楼栋地址：</label><label id="DBanAddress" class="label_content"></label>
    </div>
    <div class="am-form-group am-u-sm-4">
...
<script type="text/javascript" src="/public/static/gf/viewJs/old_month_cut.js?v=<?php echo $version; ?>"></script>
