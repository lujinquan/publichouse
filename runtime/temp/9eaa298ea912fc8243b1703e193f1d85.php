<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:63:"D:\phpStudy\WWW\ph/application/ph\view\parameter_set\index.html";i:1526464322;s:50:"D:\phpStudy\WWW\ph/application/ph\view\layout.html";i:1526912695;s:50:"application/ph/view/form/parameter_set_modify.html";i:1523846105;s:43:"application/ph/view/notice/notice_info.html";i:1523846106;s:42:"application/ph/view/index/second_menu.html";i:1523846106;}*/ ?>
<!doctype html>
<html class="no-js">
<head>
  <meta charset="utf-8">
...
<div class="am-cf admin-main">
  ...
  <div class="admin-content">
    <div class="am-cf am-padding">
      <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">系统管理</strong> / <small>参数设置</small></div>
    </div>

    <div class="am-g">
      <div class="am-u-sm-12 am-u-md-6">
        <div class="am-btn-toolbar">
          <div class="am-btn-group am-btn-group-xs aBut">
            <button type="button" id="1" class="conf-class am-btn am-btn-default"><span class="am-icon-cog"></span> 楼栋结构配置</button>
            <button type="button" id="2" class="conf-class am-btn "><span class="am-icon-cog"></span> 楼栋产别配置</button>
            <button type="button" id="3" class="conf-class am-btn "><span class="am-icon-cog"></span> 楼栋完损等级配置</button>
            <button type="button" id="4" class="conf-class am-btn "><span class="am-icon-cog"></span> 使用性质配置</button>
          </div>
