<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:74:"/usr/share/nginx/publichouse/application/ph/view/process_config/index.html";i:1560686457;s:60:"/usr/share/nginx/publichouse/application/ph/view/layout.html";i:1573559825;s:44:"application/ph/view/process_config/form.html";i:1528342025;s:43:"application/ph/view/notice/notice_info.html";i:1528342025;s:42:"application/ph/view/index/second_menu.html";i:1531059200;s:38:"application/ph/view/index/version.html";i:1578586810;}*/ ?>
<!doctype html>
<html class="no-js">
<head>
  <meta charset="utf-8">
...
<div class="admin-content am-print-hide" style="display:none;"></div>
  ...
  <div class="admin-content">
    <div class="am-cf am-padding">
      <div class="am-fl am-cf"><small class="am-text-sm">系统管理</small> > <small class="am-text-primary">流程配置</small></div>
    </div>
      ...
      <div class="am-u-sm-12 am-u-md-6">
        <div class="am-btn-toolbar">
          <div class="am-btn-group-xs">
            <button type="button" id="addProcess" class="am-btn d-btn-1188F0 am-radius">
              <span class="am-icon-plus"></span> 新增流程</button>
            <button type="button" id="modifiProcess" class="am-btn d-btn-1188F0 am-radius">
              <span class="am-icon-edit"></span> 修改流程</button>
            <button type="button" id="delProcess" class="am-btn d-btn-1188F0 am-radius">
              <span class="am-icon-trash-o"></span> 删除流程</button>
          </div>
        </div>
      </div>
    </div>
            ...
            <tr class="check001">
                ...
                <td>
                    <div class="am-btn-group am-btn-group-xs">
                      <button class="am-btn am-btn-default am-btn-xs am-text-primary am-hide-sm-only proDetail" value="<?php echo $v['id']; ?>">明细</button>
                    </div>
                </td>
            </tr>
<?php }; ?>
...
<script type="text/javascript" src="/public/static/gf/viewJs/process_config.js?v=<?php echo $version; ?>"></script>
