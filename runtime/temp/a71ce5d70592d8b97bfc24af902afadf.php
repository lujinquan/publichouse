<?php if (!defined('THINK_PATH')) exit(); /*a:8:{s:72:"/usr/share/nginx/publichouse/application/ph/view/confirm_room/index.html";i:1560686457;s:60:"/usr/share/nginx/publichouse/application/ph/view/layout.html";i:1573559825;s:42:"application/ph/view/confirm_room/form.html";i:1528342025;s:44:"application/ph/view/confirm_room/detail.html";i:1528342025;s:44:"application/ph/view/confirm_room/modify.html";i:1528342025;s:43:"application/ph/view/notice/notice_info.html";i:1528342025;s:42:"application/ph/view/index/second_menu.html";i:1531059200;s:38:"application/ph/view/index/version.html";i:1578586810;}*/ ?>
<!doctype html>
<html class="no-js">
<head>
  <meta charset="utf-8">
...
<div class="admin-content">
    <div class="am-cf am-padding">
        <div class="am-fl am-cf">
            ...
            <small class="am-text-primary">房间确认</small>
        </div>
    </div>
        ...
        <div class="am-scrollable-horizontal">
            <table class="am-table am-table-striped am-table-hover table-main am-table-centered">
                ...
                <tr>
                    ...
                    <th class="table-author am-hide-sm-only">楼栋编号</th>
                    <th class="table-author am-hide-sm-only">楼栋地址</th>
                    <th class="table-date am-hide-sm-only">房间类型</th>
                    <th class="table-date am-hide-sm-only">房间间号</th>
                    <th class="table-set">单元号</th>
                    <th class="table-set">层次</th>
                ...
                <tbody>
                <!--查询-->
                <form action="<?php echo url('ConfirmRoom/index'); ?>" method="post" id="queryForm" autocomplete="off">
                     ...
                     ?>
                        ...
                        <td>
                           <div class="am-input-group am-input-group-sm" style="width:70px;">
                                <select name="RoomType" id="doc-select-5">
                        ...
                        <td>
                            <div class="am-btn-group am-btn-group-xs" style="width:114px;">
                              ...
                              <a id="clearBanInfo" class="am-btn am-btn-xs am-text-primary ABtn" href="/ph/ConfirmRoom/index.html"><span class="ResetIcon"></span>重置</a>
                            </div>
                        </td>
                    </tr>
                </form>
                ...
                <tr class="check001">
                    ...
                    <td class="am-hide-sm-only">
                        <p style="height:18px;margin:10px 0 0;padding:0;line-height:18px;"><?php echo $v9['BanAddress']; ?></p>
                    </td>
                    <td class="am-hide-sm-only"><?php echo $v9['RoomTypeName']; ?></td>
                    <td class="am-hide-sm-only"><?php echo $v9['RoomNumber']; ?></td>
                    <td class="am-hide-sm-only"><?php echo $v9['UnitID']; ?></td>
                    <td class="am-hide-sm-only"><?php echo $v9['FloorID']; ?></td>
                    ...
                    <td>
                        <div class="am-btn-group am-btn-group-xs">
                            ...
                            <button class="am-btn am-btn-default am-text-primary am-btn-xs details" value="<?php echo $v9['RoomID']; ?>"> 明细</button>
                            <?php }; if(in_array(516,$threeMenu)){ ; ?>
                            <button class="am-btn am-btn-default am-btn-xs am-text-primary ConfirmRoomBtn" value="<?php echo $v9['RoomID']; ?>"> 确认</button>
                            <?php }; ?>
                        </div>
                    </td>
                </tr>
...
<form  id="RoomForm" class="am-form" data-am-validator style="display:none;margin-top:1.6rem;">
	  <fieldset id="InputForm" style="width:780px;">
		<div class="am-u-md-6">
			<div class="am-form-group am-u-md-12" style="display: none;">
			  <label for="doc-vld-email-2" class="label_style">房间间号：</label>
			  <div class="am-u-md-8">
				<input type="number" name="RoomID" placeholder="房间间号" required id="RoomID" />
			  </div>
			</div>
			...
			<div class="am-form-group am-u-md-12">
				...
				<div class="am-u-md-6">
					<input type="number" name="BanID" id="BanID" placeholder="楼栋编号" />
				</div>
				<div class="am-u-md-2" style="padding:0;"><a class="am-btn ABtn" id="DqueryBtn">查询</a></div>
			</div>	
				
			<!-- <div class="am-form-group am-u-md-12">
			  <label for="doc-select-8" class="label_style">完损等级：</label>
				<div class="am-u-md-8">
					<label id="LossLevel"></label>
				</div>
			</div>	
 ...
 -->
			...
			<div class="am-form-group am-u-md-12">
			  <input type="checkbox" id="PublicIdentifier" name="PublicIdentifier" /><label>3户及以上共用房间</label>
			</div>
			<div class="am-form-group am-u-md-12">
		...
		<div class="am-u-md-6">
			...
			<div class="am-form-group am-u-md-12">
			  <label for="doc-select-8" class="label_style">单元号：</label>
				<div class="am-u-md-8">
					<input type="text" name="UnitID" id="UnitID" placeholder="单元号" required/>
				</div>
			</div>
			<div class="am-form-group am-u-md-12">
			  <label for="doc-select-8" class="label_style">层次：</label>
				<div class="am-u-md-8">
					<input type="number" name="FloorID" id="FloorID" />
				</div>
			</div>
			<div class="am-form-group am-u-md-12">
			...
			<div class="am-form-group am-u-md-12">
			  <label for="doc-select-8" class="label_style">使用面积：</label>
				<div class="am-u-md-8">
					<input type="text" name="UseArea" id="" placeholder="使用面积" required/>
				</div>
			</div>
			<!--<div class="am-form-group am-u-md-12">-->
			  <!--<label for="doc-select-8" class="label_style">计租面积：</label>-->
				<!--<div class="am-u-md-8">-->
					<!--<input type="text" name="LeasedArea" id="" placeholder="计租面积" required/>-->
				<!--</div>-->
			<!--</div>-->
		</div>
	  </fieldset>
	  ...
	  <fieldset id="InputForm" style="width:780px;">
		...
		<div class="am-u-md-6">
			<div class="am-form-group am-u-md-12">
			  ...
			  <div class="am-u-md-8">
				<input type="number" name="TenantID" id="TenantI" placeholder="租户编号" required/>
			  </div>
			</div>
...
<script type="text/javascript" src="/public/static/gf/viewJs/confirm_room.js?v=<?php echo $version; ?>"></script>
