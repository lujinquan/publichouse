<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:59:"D:\phpStudy\WWW\ph/application/ph\view\rent_paid\index.html";i:1526891590;s:50:"D:\phpStudy\WWW\ph/application/ph\view\layout.html";i:1526635961;s:41:"application/ph/view/rent_paid/detail.html";i:1523846106;s:43:"application/ph/view/notice/notice_info.html";i:1523846106;s:42:"application/ph/view/index/second_menu.html";i:1523846106;}*/ ?>
<!doctype html>
<html class="no-js">
<head>
  <meta charset="utf-8">
        ...
        <div class="am-u-sm-12 am-u-md-6">
            <div class="am-btn-toolbar">
                <div class="am-btn-group am-btn-group-xs">
                    <button type="button" id="withHolding" class="am-btn am-btn-default"><span
                            class="am-icon-cog"></span> 批量标记已打发票
                    </button>
                </div>
            </div>
        </div>
    ...
    <div class="am-g">
        <div class="am-scrollable-horizontal">
            <table class="am-table am-table-striped am-table-hover table-main am-table-centered">
                ...
                <tbody>
                <!--查询-->
                <form  action="<?php echo url('RentPaid/index'); ?>" method="post" id="queryForm"><!-- id=query -->
                    <tr class="am-form-group am-form-inline am-form">
                        ...
                        <td>
                            <div class="am-input-group am-input-group-sm" style="width:150px;">
                                <?php
                                 ...
                                 ?>
                                <input style="width:70px;" type="text" name="DateStart" class="am-form-field" type="text"
                     ...
                     ?>
                        ...
                        <td>
                            <div class="am-input-group am-input-group-sm">
                                <?php
                        if(isset($rentOption['TenantName'])){
                     ...
                     ?>
                        ...
                        <td>
                            <div class="am-input-group am-input-group-sm">
                                <?php
                        if(isset($rentOption['BanAddress'])){
                     ...
                     ?>
                        ...
                        <td><div style="width:50px;"></div><?php echo $receiveRents; ?></td>
                        <td><div style="width:50px;"></div><?php echo $paidRents; ?></td>
                        <td>
                            <div style="width:50px;"></div>
                        </td>
                        <td>
                            <div class="am-btn-group am-btn-group-xs" style="width:150px;">
                                <button  class="am-btn am-btn-xs am-text-secondary"
                                ...
                                <a class="am-btn am-btn-xs am-text-secondary ABtn" href="/ph/RentPaid/index.html"><span
                ...
                <tr class="check002 thead_width">
                    ...
                    <td>
                        <div class="am-btn-toolbar">
                            ...
                            <?php if(isset($v['IfBatchSign']) && $v['IfBatchSign'] == 1){
                                $IfProcess = '';
                                $if = '已';
                            }else{
                            ...
                            ?>
                            <button class="am-btn am-btn-default am-btn-xs am-text-secondary <?php echo $IfProcess; ?>"
                                    value="<?php echo $v['RentOrderID']; ?>"><?php echo $if; ?>打印标记
                            </button>
                        </div>
                    </td>
                </tr>
...
<script type="text/javascript" src="/public/static/gf/viewJs/rent_paid.js"></script>
