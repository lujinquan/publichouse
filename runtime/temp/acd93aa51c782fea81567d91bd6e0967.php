<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:61:"D:\phpStudy\WWW\ph/application/ph\view\rent_unpaid\index.html";i:1526891590;s:50:"D:\phpStudy\WWW\ph/application/ph\view\layout.html";i:1526912695;s:43:"application/ph/view/rent_unpaid/detail.html";i:1526395919;s:43:"application/ph/view/notice/notice_info.html";i:1523846106;s:42:"application/ph/view/index/second_menu.html";i:1523846106;}*/ ?>
<!doctype html>
<html class="no-js">
<head>
  <meta charset="utf-8">
...
<div class="admin-content">
    <div class="am-cf am-padding">
        <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">租金管理</strong> /
            <small>租金欠缴</small>
        </div>
    </div>
        ...
        <div class="am-u-sm-12 am-u-md-6">
            <div class="am-btn-toolbar">
                <div class="am-btn-group am-btn-group-xs">
                    ...
                    <button type="button" id="PressForMoney" class="am-btn am-btn-default"><span
                            class="am-icon-cogs"></span> 批量催缴
                    </button>
                    <?php }; if(in_array(530,$threeMenu)){ ; ?>
                    <button type="button" id="batchRevocation" class="am-btn am-btn-default"><span
        ...
        <div class="am-u-sm-12 am-scrollable-horizontal">
            <table class="am-table am-table-striped am-table-hover table-main am-table-centered">
                    ...
                    <tr class="am-form-group am-form-inline am-form">
                        ...
                        <td>
                            <div class="am-input-group am-input-group-sm" style="width:150px;">
                                <?php
                                    if(isset($rentOption['DateStart']) && isset($rentOption['DateEnd'])){
                                        $DateStart = $rentOption['DateStart'];
                                        $DateEnd = $rentOption['DateEnd'];
                                    }else{
                                        $DateStart = '';
                                        $DateEnd = '';
                                    }
                                 ?>
                                <input style="width:70px;" name="DateStart" class="am-form-field" type="text"
                               data-am-datepicker="{format: 'yyyy/mm', viewMode: 'years',minViewMode: 'months'}"
                               value="<?php echo $DateStart; ?>" placeholder="" data-am-datepicker readonly/>
                                <input style="width:70px;" type="text" name="DateEnd" class="am-form-field" type="text"
                               data-am-datepicker="{format: 'yyyy/mm', viewMode: 'years',minViewMode: 'months'}"
                               value="<?php echo $DateEnd; ?>" placeholder="" data-am-datepicker readonly/>
                            </div>
                        </td>
                        <td>
                            <div class="am-input-group am-input-group-sm">
                     ...
                     ?>
                        ...
                        <td>
                            <div class="am-btn-group am-btn-group-xs" style="width:150px;">
                                <button id="" class="am-btn am-btn-xs am-text-secondary"
                                        style="border:1px solid #e6e6e6;">导出
                                </button>
                                <button type="submit" class="am-btn am-btn-xs am-text-secondary" id="queryBtn"><span
                                        class="DqueryIcon"></span>查询
                                </button>
                                <a class="am-btn am-btn-xs am-text-secondary ABtn"
                ...
                <tr class="check002 thead_width">
                    ...
                    <td>
                        <div class="am-btn-group am-btn-group-xs">
                            <button class="am-btn am-btn-default am-btn-xs am-text-secondary details"
                                    value="<?php echo $v['RentOrderID']; ?>">明细
                            </button>
                            <!--<button class="am-btn am-btn-default am-btn-xs am-text-secondary payment" value="<?php echo $v['RentOrderID']; ?>">缴费</button>-->
                        </div>
                    </td>
                </tr>
                <?php }; ?>
...
<form id="details" class="am-form" style="display:none;margin-top:20px;">
	<div class="am-form-group am-u-sm-12">
		<div class="am-form-group am-u-sm-6">
			<label>订单编号：</label><label id="RentOrderID"></label>
		</div>
		<div class="am-form-group am-u-sm-6">
			<label>机构名称：</label><label id="InstitutionID"></label>
		</div>
		<div class="am-form-group am-u-sm-6">
			<label>账单期：</label><label id="OrderDate"></label>
		</div>
		<div class="am-form-group am-u-sm-6">
			<label>租户姓名：</label><label id="TenantName"></label>
		</div>
		<div class="am-form-group am-u-sm-6">
			<label>房屋编号：</label><label id="HouseID"></label>
		</div>
		<div class="am-form-group am-u-sm-6">
			<label>楼栋地址：</label><label id="BanAddress"></label>
		</div>
		<div class="am-form-group am-u-sm-6 am-u-end">
			<label>单元号：</label><label id="UnitID"></label>
		</div>
		<div class="am-form-group am-u-sm-6 am-u-end">
			<label>楼层号：</label><label id="FloorID"></label>
		</div>
		<div class="am-form-group am-u-sm-6 am-u-end">
			<label>门牌号：</label><label id="DoorID"></label>
		</div>
<!-- 		<div class="am-form-group am-u-sm-6 am-u-end">
			<label>余额：</label><label id="TenantBalance"></label>
		</div> -->
		<div class="am-form-group am-u-sm-12">
			<hr />
		</div>
		<div class="am-form-group am-u-sm-6 am-u-end">
			<label>月规定租金：</label><label id="HousePrerent"></label>
		</div>
		<div class="am-form-group am-u-sm-6 am-u-end">
			<label>租金减免：</label><label id="CutRent"></label>
		</div>
		<div class="am-form-group am-u-sm-6 am-u-end">
			<label>应缴租金：</label><label id="ReceiveRent"></label>
		</div>
		<div class="am-form-group am-u-sm-6 am-u-end">
			<label>实缴金额：</label><label id="PaidRent"></label>
		</div>
		<div class="am-form-group am-u-sm-6 am-u-end">
			<label>欠缴租金：</label><label id="UnpaidRent"></label>
		</div>
		<div class="am-form-group am-u-sm-6 am-u-end">
			<label>滞纳金：</label><label id="LateRent"></label>
		</div>
	</div>
</form>
<form id="payForMoney" class="am-form" style="display:none;margin-top:20px;">
	<div class="am-form-group am-u-sm-12">
		<div class="am-form-group am-u-sm-6">
			<label>应缴租金：</label><label id="ReceiveRents"></label>
		</div>
		<div class="am-form-group am-u-sm-6">
			<label>滞纳金：</label><label id="LateRents"></label>
		</div>
		<div class="am-form-group am-u-sm-6 am-u-end">
			<label>实缴金额：</label><label id="PaidRents"></label>
		</div>
		<div class="am-form-group am-u-sm-6">
			<label>欠缴租金：</label><label id="UnpaidRents"></label>
		</div>
		<div class="am-form-group am-u-sm-6">
			<label>缴纳日期：</label>
			<input id="CreateDate" type="text" data-am-datepicker="{format: 'yyyy-mm', viewMode: 'years',minViewMode: 'months'}" placeholder="2018-5" data-am-datepicker style="width:150px;display:inline-block;" />
		</div>
		<div class="am-form-group am-u-sm-6">
			<label>缴纳费用：</label>
			<input type="number" id="money" style="width:150px;display:inline-block;" placeholder="请输入所缴费用" />
		</div>
	</div>
</form>
