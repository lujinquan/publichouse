<?php if (!defined('THINK_PATH')) exit(); /*a:7:{s:61:"D:\phpStudy\WWW\ph/application/ph\view\role_manage\index.html";i:1523846106;s:50:"D:\phpStudy\WWW\ph/application/ph\view\layout.html";i:1526912695;s:41:"application/ph/view/role_manage/form.html";i:1523846106;s:43:"application/ph/view/role_manage/modify.html";i:1523846106;s:47:"application/ph/view/role_manage/permission.html";i:1526644097;s:43:"application/ph/view/notice/notice_info.html";i:1523846106;s:42:"application/ph/view/index/second_menu.html";i:1523846106;}*/ ?>
<!doctype html>
<html class="no-js">
<head>
  <meta charset="utf-8">
...
<div class="am-cf admin-main">
  ...
  <div class="admin-content">
    <div class="am-cf am-padding">
      <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">权限管理</strong> / <small>角色管理</small></div>
    </div>
      ...
      <div class="am-u-sm-12 am-u-md-6">
        <div class="am-btn-toolbar">
          <div class="am-btn-group am-btn-group-xs">
              ...
              <button type="button" id="addRole" class="am-btn am-btn-default"><span class="am-icon-plus"></span> 新增角色</button>
              <?php }; if(in_array(215,$threeMenu)){ ; ?>
              <button type="button" id="reviseRole" class="am-btn am-btn-default"><span class="am-icon-edit"></span> 修改角色</button>
              <?php }; if(in_array(216,$threeMenu)){ ; ?>
              <button type="button" id="deleteRole" class="am-btn am-btn-default"><span class="am-icon-trash-o"></span>  删除角色</button>
              <?php }; if(in_array(219,$threeMenu)){ ; ?>
              <button type="button" id="permission" class="am-btn am-btn-default"><span class="am-icon-share"></span> 权限分配</button>
              <?php }; ?>
          </div>
        </div>
      </div>
