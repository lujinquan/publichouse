<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:60:"D:\phpStudy\WWW\ph/application/ph\view\org_manage\index.html";i:1523846106;s:50:"D:\phpStudy\WWW\ph/application/ph\view\layout.html";i:1526912695;s:40:"application/ph/view/org_manage/form.html";i:1523846106;s:42:"application/ph/view/org_manage/modify.html";i:1523846106;s:43:"application/ph/view/notice/notice_info.html";i:1523846106;s:42:"application/ph/view/index/second_menu.html";i:1523846106;}*/ ?>
<!doctype html>
<html class="no-js">
<head>
  <meta charset="utf-8">
...
<div class="am-cf admin-main">
  ...
  <div class="admin-content">
    <div class="am-cf am-padding">
      <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">权限管理</strong> / <small>机构管理</small></div>
    </div>
      ...
      <div class="am-u-sm-12 am-u-md-6">
        <div class="am-btn-toolbar">
          <div class="am-btn-group am-btn-group-xs">
              ...
              <button type="button" id="addOrg" class="am-btn am-btn-default"><span class="am-icon-plus"></span> 新增机构</button>
              <?php }; if(in_array(209,$threeMenu)){ ; ?>
              <button type="button" id="reviseOrg" class="am-btn am-btn-default"><span class="am-icon-edit"></span> 修改机构</button>
              <?php }; if(in_array(210,$threeMenu)){ ; ?>
              <button type="button" id="deleteOrg" class="am-btn am-btn-default"><span class="am-icon-trash-o"></span>  删除机构</button>
              <?php }; ?>
          </div>
        </div>
      </div>
