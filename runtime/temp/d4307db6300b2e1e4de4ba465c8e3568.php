<?php if (!defined('THINK_PATH')) exit(); /*a:7:{s:61:"D:\phpStudy\WWW\ph/application/ph\view\user_manage\index.html";i:1527069861;s:50:"D:\phpStudy\WWW\ph/application/ph\view\layout.html";i:1527069860;s:41:"application/ph/view/user_manage/form.html";i:1526912695;s:43:"application/ph/view/user_manage/modify.html";i:1523846105;s:43:"application/ph/view/user_manage/detail.html";i:1523846105;s:43:"application/ph/view/notice/notice_info.html";i:1523846106;s:42:"application/ph/view/index/second_menu.html";i:1523846106;}*/ ?>
<!doctype html>
<html class="no-js">
<head>
  <meta charset="utf-8">
      ...
      <div class="am-u-sm-12 am-u-md-6">
        <div class="am-btn-toolbar">
          <div class="am-btn-group-xs">
              ...
              <button type="button" id="addUser" class="am-btn am-btn-primary am-radius"><span class="am-icon-plus"></span> 新增用户</button>
                ...
                <tr class="am-form-group am-form-inline am-form">
                    ...
                    <td>
                        <div class="am-input-group am-input-group-sm">
                            <select name="InstitutionID" >
                                ...
                                <?php foreach($instLst as $k4 =>$v4){;                                    if($userOption != array() && $userOption['InstitutionID'] == $v4['id']){
                                        $select ='selected';
                                    }else{
                                        $select ='';
                                    }
                    ...
                    <td>
                        <div class="am-input-group am-input-group-sm">
                            <select name="PostID" >
                                <option  value="" style="display:none">请选择</option>
                                <?php foreach($postLst as $k5 =>$v5){;                                    if($userOption != array() && $userOption['PostID'] == $v5['PostID']){
                                        $select ='selected';
                                    }else{
                                        $select ='';
                                    }
...
<script type="text/javascript" src="/public/static/gf/viewJs/user_manage.js"></script>
