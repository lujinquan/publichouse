<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:60:"D:\phpStudy\WWW\ph/application/ph\view\rent_debit\index.html";i:1526875005;s:50:"D:\phpStudy\WWW\ph/application/ph\view\layout.html";i:1526635961;s:42:"application/ph/view/rent_debit/detail.html";i:1523846106;s:43:"application/ph/view/notice/notice_info.html";i:1523846106;s:42:"application/ph/view/index/second_menu.html";i:1523846106;}*/ ?>
<!doctype html>
<html class="no-js">
<head>
  <meta charset="utf-8">
...
<div class="am-cf admin-main">
  ...
  <div class="admin-content">
    <div class="am-cf am-padding">
      <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">租金管理</strong> / <small>租金扣缴</small></div>
    </div>
      ...
      <div class="am-u-sm-12 am-u-md-6">
        <div class="am-btn-toolbar">
          <div class="am-btn-group am-btn-group-xs">
            ...
            <button type="button" id="withHolding" class="am-btn am-btn-default"><span class="am-icon-cog"></span> 批量撤销扣缴</button>
            <?php }; ?>
          </div>
        </div>
      </div>
    ...
    <div class="am-g">
      <div class="am-scrollable-horizontal">
          ...
          <tbody>
		  <!--查询-->
      <form  action="<?php echo url('RentDebit/index'); ?>" method="post" id="queryForm">
		    <tr class="am-form-group am-form-inline am-form">
                    ...
                    <div class="am-input-group am-input-group-sm" style="width:210px;">
                     ...
                     ?>
                        <div class="am-u-sm-6" style="padding:0;">
                            <input type="text" name="DateStart" class="am-form-field" type="text"
                        ...
                        <div class="am-u-sm-6" style="padding:0;">
                            <input type="text" name="DateEnd" class="am-form-field" type="text"
                                   data-am-datepicker="{format: 'yyyy/mm', viewMode: 'years',minViewMode: 'months'}"
              ...
              <td>
                ...
                <td>
                    <div class="am-input-group am-input-group-sm" style="width:210px;">
                            <?php
                        if($rentOption != array()){
                            $UnpaidDateStart = $rentOption['UnpaidDateStart'];
                            $UnpaidDateEnd = $rentOption['UnpaidDateEnd'];
                        }else{
                            $UnpaidDateStart = '';
                            $UnpaidDateEnd = '';
                        }
                     ?>
                        <div class="am-u-sm-6" style="padding:0;">
                          <input style="width:100px;" name="UnpaidDateStart" value="<?php echo $UnpaidDateStart; ?>" type="text" class="am-form-field" data-am-datepicker />
                        </div>
                        <div class="am-u-sm-6" style="padding:0;">
                            <input style="width:100px;" name="UnpaidDateEnd" value="<?php echo $UnpaidDateEnd; ?>" type="text" class="am-form-field" data-am-datepicker />
                        </div>
                    </div>
                </td>
              ...
              <td>
                <div class="am-btn-group am-btn-group-xs" style="width:150px;">
                  <button  class="am-btn am-btn-xs am-text-secondary" style="border:1px solid #e6e6e6;">导出</button>
                  <button type="submit" class="am-btn am-btn-xs am-text-secondary" id="queryBtn"><span class="DqueryIcon"></span>查询</button>
                  <a class="am-btn am-btn-xs am-text-secondary ABtn" href="/ph/RentDebit/index.html"><span class="ResetIcon"></span>重置</a>
                </div>
              </td>
            </tr>
      </form>
  ...
  <form id="details" class="am-form" style="display:none;margin-top:20px;">
	<div class="am-form-group am-u-sm-12">
		...
		<div class="am-form-group am-u-sm-6">
			<label>账单期：</label><label id="PaidableTime"></label>
		</div>
		<div class="am-form-group am-u-sm-6">
...
<script type="text/javascript" src="/public/static/gf/viewJs/rent_debit.js"></script>
