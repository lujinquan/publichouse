<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:73:"/usr/share/nginx/publichouse/application/ph/view/parameter_set/index.html";i:1560686457;s:60:"/usr/share/nginx/publichouse/application/ph/view/layout.html";i:1573559825;s:50:"application/ph/view/form/parameter_set_modify.html";i:1528342025;s:43:"application/ph/view/notice/notice_info.html";i:1528342025;s:42:"application/ph/view/index/second_menu.html";i:1531059200;s:38:"application/ph/view/index/version.html";i:1578586810;}*/ ?>
<!doctype html>
<html class="no-js">
<head>
  <meta charset="utf-8">
...
<div class="admin-content am-print-hide" style="display:none;"></div>
  ...
  <div class="admin-content">
    <div class="am-cf am-padding">
      <div class="am-fl am-cf"><small class="am-text-sm">系统管理</small> > <small class="am-text-primary">参数设置</small></div>
    </div>

    <div class="am-g">
      <div class="am-u-sm-12 am-u-md-6">
        <div class="am-btn-toolbar">
          <div class="am-btn-group-xs aBut">
            <button type="button" id="1" class="conf-class am-btn d-btn-1188F0 am-radius">
              <span class="am-icon-cog"></span> 楼栋结构配置</button>
            <button type="button" id="2" class="conf-class am-btn d-btn-1188F0 am-radius">
              <span class="am-icon-cog"></span> 楼栋产别配置</button>
            <button type="button" id="3" class="conf-class am-btn d-btn-1188F0 am-radius">
              <span class="am-icon-cog"></span> 楼栋完损等级配置</button>
            <button type="button" id="4" class="conf-class am-btn d-btn-1188F0 am-radius">
              <span class="am-icon-cog"></span> 使用性质配置</button>
          </div>
      ...
      <div class="am-u-sm-12 aTab">
            ...
            <thead>
              <tr id="field">
                ...
                if($structure_type != null) {
                  echo '<td>编号</td><td>类别</td><td>操作</td>';
                } 
                ?>
              </tr><!-- 字段名称 -->
          </thead>
          ...
          if($structure_type != null){
            foreach($structure_type as $info){
              echo '<tr><td>' . $info['id'] . '</td><td>' . $info['StructureType'] . '</td>';
              echo '<td width="20%">'.
            ...
            echo '<td></td><td></td>';
            echo '<td width="20%"><div class="am-btn-group am-btn-group-xs am-u-md-offset-4"><button class="conf-add am-btn am-btn-default am-btn-xs am-text-primary am-hide-sm-only">增加</button></div></td>';
...
<div id="conf-modify" hidden="hidden" class="am-g">
	<div class="am-form-group am-u-sm-12 text-center" style="margin-top:10px;">
		<div class="am-u-md-3 l_change">
			编号:
		</div>
		<div class="am-u-md-9" id="modify-id">
			
		</div>
	</div>
	<div class="am-form-group am-u-sm-12 text-center">
		<div class="am-u-md-3 l_change">
			配置内容:
		</div>
		<div class="am-u-md-9 ">
			<input id="modify-content" type="text" value="" name="modify-content" />
		</div>
	</div>
...
<div id="conf-modify-add" hidden="hidden" class="am-g">
	<div class="am-u-md-12" style="margin-top: 20px;">
		<div class="am-u-md-3 l_change">
			配置内容:
		</div>
		<div class="am-u-md-9">
			<input id="modify-content-add" type="text" value="" name="modify-content-add"/>
		</div>
	</div>
...
<script type="text/javascript" src="/public/static/gf/viewJs/parameterset.js?v=<?php echo $version; ?>"></script>
