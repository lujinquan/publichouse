<?php if (!defined('THINK_PATH')) exit(); /*a:8:{s:71:"/usr/share/nginx/publichouse/application/ph/view/lease_audit/index.html";i:1537405974;s:60:"/usr/share/nginx/publichouse/application/ph/view/layout.html";i:1534760328;s:43:"application/ph/view/lease_apply/detail.html";i:1536300630;s:43:"application/ph/view/lease_audit/print1.html";i:1536662415;s:43:"application/ph/view/lease_audit/print2.html";i:1534760328;s:43:"application/ph/view/notice/notice_info.html";i:1528342025;s:42:"application/ph/view/index/second_menu.html";i:1531059200;s:38:"application/ph/view/index/version.html";i:1537405974;}*/ ?>
<!doctype html>
<html class="no-js">
<head>
  <meta charset="utf-8">
...
<div class="admin-content am-print-hide" style="display:none;"></div>
 ...
 <div class="admin-content">
    <div class="am-cf am-padding">
      <div class="am-fl am-cf"><small class="am-text-sm">租约管理</small> > <small class="am-text-primary">租约申请</small>&nbsp;&nbsp;<span style="font-size:14px;">租约已打印<i style="font-style:normal;color:red;"><?php echo $ids; ?></i>份</span></div>
    </div>
                ...
                <tr>
                    ...
                    <td id="print_1_Room15_data4">
                      ...
                      <td><input type="hidden" name="ZGGF_FJLX1" id="ZGGF_FJLX1" value="" truetype="hidden"></td>
                        ...
                        <tr>
                            <td colspan="2" id="print_1_Room16_data1"> <input type="hidden" name="ZGGF_FJLX2" id="ZGGF_FJLX2" value="" truetype="hidden"></td>
                            <td id="print_1_Room16_data2"><input type="hidden" name="ZGGF_FJH2" id="ZGGF_FJH2" value="" truetype="hidden"></td>
                            <td id="print_1_Room16_data3"><input type="hidden" name="ZGGF_FSM2" id="ZGGF_FSM2" value="" truetype="hidden"></td>
                            <td id="print_1_Room16_data4"><input type="hidden" name="ZGGF_FJM2" id="ZGGF_FJM2" value="" truetype="hidden"></td>
                            <td id="print_1_Room16_data5"><input type="hidden" name="ZGGF_FYZJ2" id="ZGGF_FYZJ2" value="" truetype="hidden"></td>
                            <td colspan="2">合计</td>
                ...
                <div style="width: 100%; ">
                    ...
                    <table class="pzqk" cellspacing="" cellpadding="" style="width:100%;margin-top: 5px;height:538px;border-left-width:0px;border-right-width:0px;border-bottom-width:0px;">
                        ...
                        <tr>
                            ...
                            <td colspan="2">高1.7至2.2米搁楼</td>
                            <td id="printer_2_Room12_data6">
                            </td>
                            <td id="printer_2_Room12_data7">
                                </td>
                            <td style="border-right-width:0px;" id="printer_2_Room12_data8">
                                </td>
                        </tr>
                        <tr>
                            <td>共</td>
...
<script type="text/javascript" src="/public/static/gf/viewJs/lease_audit.js"></script>
