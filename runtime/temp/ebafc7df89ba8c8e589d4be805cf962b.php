<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:73:"/usr/share/nginx/publichouse/application/ph/view/in_out_report/index.html";i:1528342025;s:60:"/usr/share/nginx/publichouse/application/ph/view/layout.html";i:1534760328;s:42:"application/ph/view/form/InOut_report.html";i:1528342025;s:43:"application/ph/view/notice/notice_info.html";i:1528342025;s:42:"application/ph/view/index/second_menu.html";i:1531059200;s:38:"application/ph/view/index/version.html";i:1533542784;}*/ ?>
<!doctype html>
<html class="no-js">
<head>
  <meta charset="utf-8">
...
<div class="admin-content">
    ...
    <div class="am-g">
        ...
        <form action="<?php echo url('InOutReport/index'); ?>" method="post" class="am-form am-print-hide am-u-md-12" style="margin-bottom:20px;" id="queryForm">
            <div class="am-u-md-12">
                <div class="label_style">产别：</div>
                <div class="am-u-md-2">
                    <select name="OwnerType" id="OwnerType" >
                        <option  value="3" style="display:none">代管</option>
                        <?php foreach($owerLst as $k1 =>$v1){ ;                        if($inoutReportOption != array()){
                ...
                <div class="am-u-md-2">
                    ...
                    <select name="TubulationID" id="iTubulationID">
                        ...
                        <?php if(session('user_base_info.institution_level')==1){;foreach($instLst as $k10 => $v10){ if($v10['level'] !=0 ){;                                 if($inoutReportOption != array()){
                        ...
                        <?php }}}elseif(session('user_base_info.institution_level')==2){; foreach($instLst as $k12 => $v12){ ;                                 if($inoutReportOption != array()){
                ...
                <div class="am-u-md-2">
                    ...
                    ?>
                    <input type="text" name="month" value="<?php echo $month; ?>" class="am-u-md-8" data-am-datepicker="{format: 'yyyy-mm', viewMode: 'years',minViewMode: 'months'}" placeholder="日历组件" data-am-datepicker readonly id="chooseMonth" />
                </div>
        ...
        <div style="padding-left:6px;">
            <?php if($arr){ ; ?>
<div style="display:inline-block;width:30%">填报单位：<?php echo $inst; ?></div>
<div style="display:inline-block;width:30%">单位：元/平方米</div>
<table class="am-table am-table-bordered am-table-centered" id="PropertyForm">
        <tbody>
            <tr>
                <th rowspan="2" colspan="1" class="am-text-middle">序号</th>
                <th rowspan="2" colspan="1" class="am-text-middle">管段</th>
                <th rowspan="2" colspan="1" class="am-text-middle">账号</th>
                <th rowspan="2" colspan="1" class="am-text-middle">业主姓名</th>
                <th rowspan="2" colspan="1" class="am-text-middle">房屋地址</th>
                <th rowspan="2" colspan="1" class="am-text-middle">建筑面积</th>
                <th rowspan="1" colspan="2" class="am-text-middle">收入</th>
            ...
            <tr>
                <th rowspan="1" colspan="1" class="am-text-middle">房租</th>
                <th rowspan="1" colspan="1" class="am-text-middle">其中：企</th>
            ...
            <tr>
                <td rowspan="1" colspan="1" class="am-text-middle"><?php echo ++$k1; ?></td>
                <td rowspan="1" colspan="1" class="am-text-middle"><?php echo $v1['Institution']; ?></td>
                <td rowspan="1" colspan="1" class="am-text-middle"></td>
                <td rowspan="1" colspan="1" class="am-text-middle"><?php echo $v1['TenantName']; ?></td>
                <td rowspan="1" colspan="1" class="am-text-middle"><?php echo $v1['BanAddress']; ?></td>
                <td rowspan="1" colspan="1" class="am-text-middle"><?php echo $v1['HouseArea']; ?></td>
                <td rowspan="1" colspan="1" class="am-text-middle"><?php echo $v1['HousePrerent']; ?></td>
                <td rowspan="1" colspan="1" class="am-text-middle"></td>
                <td rowspan="1" colspan="1" class="am-text-middle"></td>
                <td rowspan="1" colspan="1" class="am-text-middle"><?php echo $v1['RepairCost']; ?></td>
                <td rowspan="1" colspan="1" class="am-text-middle"><?php echo $v1['HandlerCost']; ?></td>
                <td rowspan="1" colspan="1" class="am-text-middle"><?php echo $v1['Cost']; ?></td>
                <td rowspan="1" colspan="1" class="am-text-middle"></td>
            </tr>
            <?php }; ?>
        </tbody>
...
<div style="display:inline-block;width:100%">
    <div style="display:inline-block;width:24%;text-align:center;">单位主管：</div>
    <div style="display:inline-block;width:24%;text-align:center;">财会：</div>
    <div style="display:inline-block;width:24%;text-align:center;">经办人：</div>
    <div style="display:inline-block;width:24%;text-align:center;"><?php echo date('Y年m月',strtotime($month)); ?></div>
</div>
<div class="am-cf">
    共<?php echo $plist->total(); ?>条记录
    <div class="am-fr">
