<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:69:"/usr/share/nginx/publichouse/application/ph/view/rent_paid/index.html";i:1560686457;s:60:"/usr/share/nginx/publichouse/application/ph/view/layout.html";i:1573559825;s:41:"application/ph/view/rent_paid/detail.html";i:1550747577;s:43:"application/ph/view/notice/notice_info.html";i:1528342025;s:42:"application/ph/view/index/second_menu.html";i:1531059200;s:38:"application/ph/view/index/version.html";i:1578586810;}*/ ?>
<!doctype html>
<html class="no-js">
<head>
  <meta charset="utf-8">
...
<div class="admin-content">
    <div class="am-cf am-padding">
        <div class="am-fl am-cf"><small class="am-text-sm">租金管理</small> >
            <small class="am-text-primary">租金已缴</small>
        </div>
    </div>
        ...
        <div class="am-u-sm-12 am-u-md-6">
            <div class="am-btn-toolbar">
                <div class="am-btn-group-xs">
                    <?php if(in_array(263,$threeMenu)){ ; ?>
                    <button type="button" id="withHolding" class="am-btn d-btn-1188F0 am-radius"><span
                            class="am-icon-cog"></span> 批量标记已打发票
                    </button>
                    <?php }; if(in_array(535,$threeMenu)){ ; ?>
            ...
            <table class="am-table am-table-striped am-table-hover table-main am-table-centered">
                ...
                <form  action="<?php echo url('RentPaid/index'); ?>" method="post" id="queryForm"><!-- id=query -->
                    <tr class="am-form-group am-form-inline am-form">
                     ...
                     ?>
                                <input style="width:200px;" name="RentOrderID" type="text" class="am-form-field" value="<?php echo $RentOrderID; ?>">
                            </div>
                        </td>
                     ...
                     ?>
                                <input style="width:132px;" name="BanAddress" type="text" class="am-form-field" value="<?php echo $BanAddress; ?>">
                            </div>
                        </td>
                        ...
                        <td>
                            <div class="am-btn-group am-btn-group-xs">
                                ...
                                <a class="am-btn am-btn-xs am-text-primary ABtn" href="/ph/RentPaid/index.html"><span class="ResetIcon"></span>重置</a>
                            </div>
                        </td>
                ...
                <tr class="check002 thead_width">
                    ...
                    <td>
                        <div class="am-btn-toolbar am-btn-group-xs" style="width:150px;">
                            ...
                            ?>
                            <button class="am-btn am-btn-default am-btn-xs am-text-primary <?php echo $IfProcess; ?>"
...
<form id="payForMoney" class="am-form" style="display:none;margin-top:20px;">
	<div class="am-form-group am-u-sm-12">
<!-- 		<div class="am-form-group am-u-sm-6">
			<label>订单编号：</label><label class="RentOrderID"></label>
		</div> -->
		<div class="am-form-group am-u-sm-6">
...
<script type="text/javascript" src="/public/static/gf/viewJs/rent_paid.js?v=<?php echo $version; ?>"></script>
