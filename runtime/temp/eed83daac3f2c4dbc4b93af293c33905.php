  ...
  <div class="admin-content">
    <div class="am-cf am-padding">
      <div class="am-fl am-cf">
        ...
        <small class="am-text-primary">维修审批</small>
      </div>
    </div>
      ...
      <div class="am-u-sm-12 am-u-md-6">
        <div class="am-btn-toolbar">
          <div class="am-btn-group-xs">
            ...
            <button type="button" id="addMRepair" class="am-btn d-btn-1188F0 am-radius"><span class="am-icon-plus"></span> 中修审批</button>
              <?php }; if(in_array(46,$threeMenu)){ ; ?>
            <button type="button" id="addBRepair" class="am-btn d-btn-1188F0 am-radius addRepair" value="2"><span class="am-icon-save"></span> 大修审批</button>
              <?php }; if(in_array(47,$threeMenu)){ ; ?>
            <button type="button" id="addSafetyRepair" class="am-btn d-btn-1188F0 am-radius addRepair" value="3"><span class="am-icon-trash-o"></span> 排危审批</button>
              <?php }; if(in_array(47,$threeMenu)){ ; ?>
            <button type="button" class="am-btn d-btn-1188F0 am-radius addRepair" value="4"><span class="am-icon-trash-o"></span> 电器线隐患整治审批</button>
              <?php }; ?>
          </div>
        </div>
      </div>
      ...
      <form id="query" action="<?php echo url('BanInfo/index'); ?>" method="post">
		    <tr class="am-form-group am-form-inline am-form">
              ...
              <td>
                ...
                <a class="am-btn am-btn-xs am-text-primary" style="border:1px solid #e6e6e6;background:#FFF;" href="/ph/RepairExamine/index.html">重置</a>
            ...
            <tr class='check001'>
              ...
              <td>
                  <div class="am-btn-group am-btn-group-xs">
                    ...
                    <button class="am-btn am-btn-default am-btn-xs am-text-primary am-hide-sm-only addMaterial" value="">审批</button>
                  </div>
              </td>
            </tr>
          </tbody>
