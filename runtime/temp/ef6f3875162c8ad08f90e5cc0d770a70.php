                ...
                <tr class="check001">
                    ...
                    <td>
                        <div class="am-btn-group am-btn-group-xs">
                            ...
                            <button class="am-btn am-btn-default am-text-primary am-btn-xs details details_btn am-hide-sm-only BtnDetail" value="<?php echo $v['ChangeOrderID']; ?>">明细
                            </button>
                            <?php }; ?>
                        </div>
                    </td>
