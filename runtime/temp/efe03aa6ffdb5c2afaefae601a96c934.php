<?php if (!defined('THINK_PATH')) exit(); /*a:20:{s:72:"/usr/share/nginx/publichouse/application/ph/view/change_audit/index.html";i:1533511343;s:60:"/usr/share/nginx/publichouse/application/ph/view/layout.html";i:1534760328;s:44:"application/ph/view/change_audit/derate.html";i:1531829126;s:47:"application/ph/view/change_audit/emptyRent.html";i:1533511343;s:49:"application/ph/view/change_audit/approveForm.html";i:1531829126;s:43:"application/ph/view/change_audit/pause.html";i:1531829126;s:44:"application/ph/view/change_audit/cancel.html";i:1534823114;s:47:"application/ph/view/change_audit/oldCancel.html";i:1533511343;s:52:"application/ph/view/change_audit/rentAdjustment.html";i:1531965142;s:45:"application/ph/view/change_audit/rentAdd.html";i:1533511343;s:50:"application/ph/view/change_audit/AdjustDetail.html";i:1528342025;s:56:"application/ph/view/change_audit/buildingAdjustment.html";i:1533511343;s:48:"application/ph/view/change_audit/RoomDetail.html";i:1528342025;s:49:"application/ph/view/change_audit/houseAdjust.html";i:1533511343;s:45:"application/ph/view/change_audit/newRent.html";i:1533511343;s:40:"application/ph/view/ban_info/detail.html";i:1533511343;s:44:"application/ph/view/house_info/RentForm.html";i:1534760328;s:43:"application/ph/view/notice/notice_info.html";i:1528342025;s:42:"application/ph/view/index/second_menu.html";i:1531059200;s:38:"application/ph/view/index/version.html";i:1537405974;}*/ ?>
<!doctype html>
<html class="no-js">
<head>
  <meta charset="utf-8">
		    ...
		    <tr class="am-form-group am-form-inline">
              ...
              <td>
                    ...
                    <select name="ChangeType">
                        ...
                        <?php foreach($changes as $k0 => $v0){ ;                             if($changeOption != array()){
                ...
                <td>
                    <div class="am-form-group am-form" style="width:100px;">       
                        <select name="TubulationID">
                            <option  value="" style="display:none">请选择</option>
                            <?php if(session('user_base_info.institution_level')==1){;foreach($instLst as $k10 => $v10){ if($v10['level'] !=0 ){;                                 if($changeOption != array()){
                            ...
                            <?php }}}elseif(session('user_base_info.institution_level')==2){; foreach($instLst as $k12 => $v12){ ;                                 if($changeOption != array()){
              ...
              <div class="am-input-group am-input-group-sm">
                     ...
                     ?>
                <input type="text" class="am-form-field" name="InflRent" value="<?php echo $InflRent; ?>">
              </div>
              </td>
              <td>
        				<div class="am-input-group am-input-group-sm">
                ...
                <td>
                    ...
                    <div class="am-u-sm-6" style="padding:0;">
                          <input style="width:200px;" name="CreateTime" value="<?php echo $CreateTime; ?>" type="text" class="am-form-field" data-am-datepicker value="">
                    </div>
          ...
          <tr class="check001">
              ...
              <td>
                  <div class="am-btn-group am-btn-group-xs">
                      ...
                      <button class="am-btn am-btn-default am-text-primary am-btn-xs details am-hide-sm-only BtnDetail" value="<?php echo $v['ChangeOrderID']; ?>">明细</button>
                      ...
                      <?php }; if(in_array(534,$threeMenu)){ ; ?>
                      <button class="am-btn am-btn-default am-text-primary am-btn-xs details am-hide-sm-only BtnDelete" value="<?php echo $v['ChangeOrderID']; ?>">删除</button>
                      <?php }; ?>
                  </div>
              </td>
          </tr>
        ...
        <table class="am-table am-table-striped am-table-hover am-table-centered am-table-compact overflow_tbody" style="border:1px solid #ccc;">
            <thead style="display:block;">
                <tr>
                    ...
                    <td style="width:200px;" class="am-hide-sm-only">房屋地址</td>
                </tr>
            </thead>
        ...
        <table class="am-table am-table-striped am-table-hover am-table-centered am-table-compact overflow_tbody" style="border:1px solid #ccc;">
            <thead style="display:block;">
                <tr>
                    ...
                    <td style="width:250px;" class="am-hide-sm-only">房屋地址</td>
                </tr>
            </thead>
    ...
    <div class="am-u-sm-12 " style="overflow-x:scroll">
    	<table class="adjusHouse_table" border="1" style="width:1360px;border:1px solid #D6E2F6;text-align:center;">
    		<tr>
    			...
    			<th colspan="2" rowspan="2">房屋地址</th>
    			<th colspan="3" rowspan="1">租金</th>
...
<script type="text/javascript" src="/public/static/gf/viewJs/ban_form.js"></script>
