<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:76:"/usr/share/nginx/publichouse/application/ph/view/dangerous_report/index.html";i:1528342025;s:60:"/usr/share/nginx/publichouse/application/ph/view/layout.html";i:1573559825;s:46:"application/ph/view/form/dangerous_report.html";i:1528342025;s:43:"application/ph/view/notice/notice_info.html";i:1528342025;s:42:"application/ph/view/index/second_menu.html";i:1531059200;s:38:"application/ph/view/index/version.html";i:1578586810;}*/ ?>
<!doctype html>
<html class="no-js">
<head>
  <meta charset="utf-8">
...
<div class="admin-content">
    ...
    <div class="am-g">
        ...
        <form action="<?php echo url('DangerousReport/index'); ?>" method="post" class="am-form am-print-hide am-u-md-12" style="margin-bottom:20px;" id="queryForm">
            <div class="am-u-md-12">
                ...
                <div class="am-u-md-2">
                    ...
                    <select name="TubulationID" id="TubulationI">
                        ...
                        <?php if(session('user_base_info.institution_level')==1){;foreach($instLst as $k10 => $v10){ if($v10['level'] !=0 ){;                                 if($dangerousOption != array()){
                        ...
                        <?php }}}elseif(session('user_base_info.institution_level')==2){; foreach($instLst as $k12 => $v12){ ;                                 if($dangerousOption != array()){
    ...
    <div style="display:inline-block;width:30%" class="time fontSize_12">填报时间：<?php echo $month; ?></div>
        <tbody>
            <tr>
                <th rowspan="1" colspan="1" class="am-text-middle">房屋座落</th>
                <th rowspan="1" colspan="1" class="am-text-middle">栋号</th>
                <th rowspan="1" colspan="1" class="am-text-middle">建成年份</th>
                <th rowspan="1" colspan="1" class="am-text-middle">层数</th>
                <th rowspan="1" colspan="1" class="am-text-middle">完损等级</th>
                <th rowspan="1" colspan="1" class="am-text-middle">机构类别</th>
                <th rowspan="1" colspan="1" class="am-text-middle">建筑面积</th>
                <th rowspan="1" colspan="1" class="am-text-middle">规定租金</th>
            </tr>
            <?php if(is_array($plist) || $plist instanceof \think\Collection || $plist instanceof \think\Paginator): $i = 0; $__LIST__ = $plist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$ptest): $mod = ($i % 2 );++$i;?>
            <tr>
                <td rowspan="1" colspan="1" class="am-text-middle"><?php echo $ptest['BanAddress']; ?></td>
                <td rowspan="1" colspan="1" class="am-text-middle"><?php echo $ptest['BanUnitNum']; ?></td>
                <td rowspan="1" colspan="1" class="am-text-middle"><?php echo $ptest['BanYear']; ?></td>
                <td rowspan="1" colspan="1" class="am-text-middle"><?php echo $ptest['BanFloorNum']; ?></td>
                <td rowspan="1" colspan="1" class="am-text-middle"><?php echo $ptest['DamageGrade']; ?></td>
                <td rowspan="1" colspan="1" class="am-text-middle"><?php echo $ptest['Institution']; ?></td>
                <td rowspan="1" colspan="1" class="am-text-middle"><?php echo $ptest['TotalArea']; ?></td>
                <td rowspan="1" colspan="1" class="am-text-middle"><?php echo $ptest['PreRent']; ?></td>
            </tr>
