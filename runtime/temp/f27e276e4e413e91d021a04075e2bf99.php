<?php if (!defined('THINK_PATH')) exit(); /*a:9:{s:68:"/usr/share/nginx/publichouse/application/ph/view/ban_info/index.html";i:1573559825;s:60:"/usr/share/nginx/publichouse/application/ph/view/layout.html";i:1573559825;s:38:"application/ph/view/ban_info/form.html";i:1563009962;s:40:"application/ph/view/ban_info/modify.html";i:1573559825;s:40:"application/ph/view/ban_info/detail.html";i:1533511343;s:47:"application/ph/view/ban_info/ban_structure.html";i:1528342025;s:43:"application/ph/view/notice/notice_info.html";i:1528342025;s:42:"application/ph/view/index/second_menu.html";i:1531059200;s:38:"application/ph/view/index/version.html";i:1578586810;}*/ ?>
<!doctype html>
<html class="no-js">
<head>
  <meta charset="utf-8">
          ...
          <table class="am-table am-table-striped am-table-hover table-main am-table-centered">
            <thead>
              <tr>
                ...
                <th class="table-title table-th-length">原编号</th>
		    ...
		    <tr class="am-form-group am-form-inline am-form">
              ...
              <td>
                <div class="am-input-group am-input-group-sm">
                    <?php
                        if($banOption != array()){
                            $OldBanID = $banOption['OldBanID'];
                        }else{
                            $OldBanID = '';
                        }
                     ?>
                  <input name="OldBanID" type="text" class="am-form-field" value="<?php echo $OldBanID; ?>">
                </div>
              </td>
              ...
              <td>
                <div class="am-input-group am-input-group-sm">
                    <?php
                     ...
                     ?>
                  <input style="width:130px;" name="AreaFour" type="text" class="am-form-field" value="<?php echo $AreaFour; ?>">
                </div>
              </td>
              <td class="dong_none">
                <div class="am-input-group am-input-group-sm">
                    <?php
                     ...
                     ?>
                  <input style="width:80px;" name="BanPropertyID" type="text" class="am-form-field" value="<?php echo $BanPropertyID; ?>">
                </div>
              </td>
              <td class="dong_none">
                <div class="am-input-group am-input-group-sm" style="width:60px;">
                    <?php
                     ...
                     ?>
                    <input style="width:60px;" name="BanYear" value="<?php echo $BanYear; ?>" type="text" class="am-form-field" data-am-datepicker="{format: 'yyyy ', viewMode: 'years', minViewMode: 'years'}" >
                </div>
              </td>
              <td>
                  <div class="am-form-group search_input">
                ...
                <td>
                    <div class="am-input-group am-input-group-sm">
                     ...
                     ?>
                            <input style="width:80px;" name="TotalArea" type="text" class="am-form-field" value="<?php echo $TotalArea; ?>">
                    </div>
                </td>
...
<!-- 			<div class="am-form-group am-u-md-12">
		...
		<div class="am-u-md-6 j-upload">
			...
			<div class="am-form-group am-u-md-12">
			  <label style="float:left;">影像资料：</label>
				<div class="am-form-group am-form-file am-u-md-8">
				  <i class="am-icon-cloud-upload"></i> 选择要上传的文件
	  ...
	  <fieldset style="width:780px;">
		...
		<div class="am-u-md-12">
			<div class="am-form-group am-u-md-12">
				<label>楼栋地址：</label>&nbsp;&nbsp;&nbsp;
				<div class="inline_70">
					<select disabled ><option>武昌区</option></select>
				</div>
				<div style="width:120px;" class="inline_70">
					<select name="AreaTwo" disabled id="AreaTw" required>
						<option  value="" style="display:none">请选择</option>
					</select>
				</div>
				<div style="width:120px;" class="inline_70">
					<select name="AreaThree" disabled id="AreaThre" required>
						<option  value="" style="display:none">请选择</option>
				...
				<input type="text" name="AreaFour" readonly id="AreaFou" style="width:215px;display:inline-block;" required/>
				&nbsp;&nbsp;&nbsp;&nbsp;<i style="font-style: normal; color:red; vertical-align: middle;">*</i>
			</div>
		</div>
		<div class="am-u-md-6">
			<div class="am-form-group am-u-md-12">
			  ...
			  <div class="am-u-md-8">
				<input type="number" readonly onfocus=this.blur() name="BanID" id="BanID" required/>
			  </div>
<!-- 			  <label>
...
<!-- 			<div class="am-form-group am-u-md-12">
			...
			<div class="am-form-group am-u-md-12">
			  <label for="" class="label_style">栋号：</label>
			  <div class="am-u-md-8">
				<input type="text" readonly name="BanNumber" id="BanNumber" required/>
			  </div>
				<i style="font-style: normal; color:red; vertical-align: middle;">*</i>
			</div>
			...
			<div class="am-form-group am-u-md-12">
			  ...
			  <div class="am-u-md-8" style="float:left;">
				<select name="TubulationID" disabled id="tubulationID" >
			...
			<div class="am-form-group am-u-md-12">
				...
				<div class="am-u-md-8">
					<input type="number" name="EnterpriseArea" readonly id="EnterpriseArea" minlength="1"  required/>
				</div>
				<i style="font-style: normal; color:red; vertical-align: middle;">*</i>
			</div>
			<div class="am-form-group am-u-md-12">
				...
				<div class="am-u-md-8">
					<input type="number" name="EnterpriseRent" readonly id="EnterpriseRent" minlength="1"  required/>
				</div>
				<i style="font-style: normal; color:red; vertical-align: middle;">*</i>
			</div>
			<div class="am-form-group am-u-md-12">
				...
				<div class="am-u-md-8">
					<input type="number" name="EnterpriseOprice" readonly id="EnterprisePrice" minlength="1"  required/>
				</div>
				<i style="font-style: normal; color:red; vertical-align: middle;">*</i>
			</div>
			<div class="am-form-group am-u-md-12">
				...
				<div class="am-u-md-8">
					<input type="number" name="EnterpriseNum" readonly id="EnterpriseNumber" minlength="1"  required/>
				</div>
				<i style="font-style: normal; color:red; vertical-align: middle;">*</i>
			</div>
			...
			<div class="am-form-group am-u-md-12">
				...
				<div class="am-u-md-8">
					<input type="number" name="PartyArea" readonly id="PartyArea" required/>
				</div>
				<i style="font-style: normal; color:red; vertical-align: middle;">*</i>
			</div>
			<div class="am-form-group am-u-md-12">
				...
				<div class="am-u-md-8">
					<input type="number" name="PartyRent" readonly id="PartyRent" minlength="1"  required/>
				</div>
				<i style="font-style: normal; color:red; vertical-align: middle;">*</i>
			</div>
			<div class="am-form-group am-u-md-12">
				...
				<div class="am-u-md-8">
					<input type="number" name="PartyOprice" readonly id="PartyPrice" minlength="1"  required/>
				</div>
				<i style="font-style: normal; color:red; vertical-align: middle;">*</i>
			</div>
			<div class="am-form-group am-u-md-12">
				...
				<div class="am-u-md-8">
					<input type="number" name="PartyNum" readonly id="PartyNumber" minlength="1"  required/>
				</div>
				<i style="font-style: normal; color:red; vertical-align: middle;">*</i>
			</div>
			...
			<div class="am-form-group am-u-md-12">
				...
				<div class="am-u-md-8">
					<input type="number" name="CivilArea" readonly id="CivilArea" required/>
				</div>
				<i style="font-style: normal; color:red; vertical-align: middle;">*</i>
			</div>
			<div class="am-form-group am-u-md-12">
				...
				<div class="am-u-md-8">
					<input type="number" name="CivilRent" readonly id="CivilRent" minlength="1"  required/>
				</div>
				<i style="font-style: normal; color:red; vertical-align: middle;">*</i>
			</div>
			<div class="am-form-group am-u-md-12">
				...
				<div class="am-u-md-8">
					<input type="number" name="CivilOprice" readonly id="CivilPrice" minlength="1"  required/>
				</div>
				<i style="font-style: normal; color:red; vertical-align: middle;">*</i>
			</div>
			<div class="am-form-group am-u-md-12">
				...
				<div class="am-u-md-8">
					<input type="number" name="CivilNum" readonly id="CivilNumber" minlength="1"  required/>
				</div>
				<i style="font-style: normal; color:red; vertical-align: middle;">*</i>
			</div>
			...
			<div class="am-form-group am-u-md-12">
				...
				<div class="am-u-md-8">
					<input type="number" name="BanUsearea" readonly id="BanUsearea" required/>
				</div>
				<i style="font-style: normal; color:red; vertical-align: middle;">*</i>
			</div>
...
<!-- 			<div class="am-form-group am-u-md-12">
			...
			<div class="am-form-group am-u-md-12">
				<label for="doc-select-8" class="label_style">占地面积：</label>
				<div class="am-u-md-8">
					<input type="number" name="CoveredArea" readonly id="editCoveredArea" required/>
				</div>
				<i style="font-style: normal; color:red; vertical-align: middle;">*</i>
			</div>
			<div class="am-form-group am-u-md-12">
				<label for="doc-select-8" class="label_style">证载面积：</label>
				<div class="am-u-md-8">
					<input type="number" name="ActualArea" readonly id="editActualArea" required/>
				</div>
			</div>
			...
			<div class="am-form-group am-u-md-12">
				...
				<div class="am-u-md-8">
					<input type="text" name="BanPropertyID" readonly id="BanPropertyID" required/>
				</div>
				<i style="font-style: normal; color:red; vertical-align: middle;">*</i>
			</div>
			...
			<div class="am-form-group am-u-md-12">
			  <label for="doc-select-8" class="label_style">土地证号：</label>
				<div class="am-u-md-8">
					<input type="text" name="BanLandID" readonly id="BanLandI" />
				</div>
			</div>			
		...
		<div class="am-u-md-6">
			...
			<div class="am-form-group am-u-md-12">
				<label for="doc-select-4" class="label_style">完损等级：</label>
				<div  class="am-u-md-8" style="float:left;">
					<select name="DamageGrade" disabled id="doc-select-4" class="DamageGraded" required>
						<?php foreach($damaLst as $k2 =>$v2){;?>
			...
			<div class="am-form-group am-u-md-12">
			  <label for="doc-select-5" class="label_style">楼栋产别：</label>
			  <div class="am-u-md-8" style="float:left;">
				<select name="OwnerType" disabled id="ownerType" >
					<?php foreach($owerLst as $k3 =>$v3){;?>
...
<!-- 			<div class="am-form-group am-u-md-12">
			...
			<div class="am-form-group am-u-md-12">
			  <label for="doc-select-7" class="label_style">使用性质：</label>
			  <div class="am-u-md-8" style="float:left;">
				<select name="UseNature" disabled class="UseNatured" >
					<option  value="" style="display:none">请选择</option>
					<?php foreach($useNatureLst as $k5 =>$v5){ ;?>
					<option value="<?php echo $v5['id']; ?>"><?php echo $v5['UseNature'];?></option>
					<?php }; ?>
			...
			<div class="am-form-group am-u-md-12">
			  <label for="doc-select-8" class="label_style">结构类别：</label>
			  <div class="am-u-md-8" style="float:left;">
				<select name="StructureType" disabled class="StructureTyped" disabled>
						<?php foreach($struLst as $k4 =>$v4){;?>
			...
			<div class="am-form-group am-u-md-12">
				...
				<div class="am-u-md-8" data-am-validator>
					<input type="text" name="BanYear" id="BanYear" disabled data-am-datepicker="{format: 'yyyy ', viewMode: 'years', minViewMode: 'years'}" required/>
				</div>
				<i style="font-style: normal; color:red; vertical-align: middle;">*</i>
			</div>
			<!--新加-->
			<div class="am-form-group am-u-md-12">
			  <label for="doc-select-8" class="label_style">单元数量：</label>
				<div class="am-u-md-8">
					<input type="number" name="BanUnitNum" readonly id="BanUnitNum" required/>
				</div>
				<i style="font-style: normal; color:red; vertical-align: middle;">*</i>
			</div>
			...
			<div class="am-form-group am-u-md-12">
			  <label for="doc-select-8" class="label_style">起始楼层：</label>
				<div class="am-u-md-8">
					<input type="number" name="BanFloorStart" readonly id="BanFloorStart" required/>
				</div>
			</div>
			...
			<div class="am-form-group am-u-md-12">
			  <label for="doc-select-8" style="float:left;">拆迁状态：</label>
				<div class="am-u-md-8">
					<select name="RemoveStatus" disabled id="RemoveStatus">
						<option value="1">未拆迁</option>
						<option value="2">已拆未下基数</option>
						<option value="3">已拆且下基数</option>
					</select>
			...
			<div class="am-form-group am-u-md-12">
			  <label for="doc-select-8" style="float:left;">建筑状态：</label>
				<div class="am-u-md-8">
					<select name="HistoryIf" disabled id="HistoryIf">
						<option value="0">非优秀</option>
			...
			<div class="am-form-group am-u-md-12">
			  <label for="doc-select-8" style="float:left;">电梯状态：</label>
				<div class="am-u-md-8">
					<select name="IfElevator" disabled id="doc-select-5" class="IfElevatorM">
						<option value="0">无电梯</option>
						<option value="1">有电梯且免费</option>
						<option value="2">有电梯需缴费</option>
					 </select>
			...
			<div class="am-form-group am-u-md-12">
				<label for="doc-select-8" class="label_style">产权来源：</label>
				<div class="am-u-md-8">
					<input type="text" name="PropertySource" readonly id="PropertySource" placeholder="" />
				</div>
			</div>
			<div class="am-form-group am-u-md-12">
				<label for="doc-select-8" class="label_style">不动产证：</label>
				<div class="am-u-md-8">
					<input type="text" name="BanFreeholdID" readonly id="BanFreeholdI" />
				</div>
			</div>	
			...
			<div class="am-form-group am-u-md-12">
			  <label for="doc-select-8" class="label_style">总户数：</label>
				<div class="am-u-md-8">
					<input type="number" name="TotalHouseholds" readonly id="TotalHouseholds" />
				</div>
				<i style="font-style: normal; color:red; vertical-align: middle;">*</i>
			</div>
			<div class="am-form-group am-u-md-12">
				<label for="doc-select-8" class="label_style">栋系数：</label>
				<div class="am-u-md-8">
					<input type="number" name="BanRatio" readonly id="BanRatio" required/>
				</div>
				<i style="font-style: normal; color:red; vertical-align: middle;">*</i>
			</div>
			...
			<div class="am-form-group am-u-md-12">
				...
				<div class="am-u-md-8">
					<label class="am-radio-inline">
						<input type="radio"  value="1" name="ReformIf" disabled checked="checked" required> 是
					</label>
					<label class="am-radio-inline">
						<input type="radio" value="0" name="ReformIf" disabled> 否
					</label>
				</div>
				<i style="font-style: normal; color:red; vertical-align: middle;">*</i>
			</div>
			...
			<div class="am-form-group am-u-md-12">
			  ...
			  <div class="am-u-md-6">
					<label class="am-radio-inline">
						<input type="radio"  value="1" name="ProtectculturalIf" disabled required> 是
					</label>
					<label class="am-radio-inline">
						<input type="radio" value="0" name="ProtectculturalIf" disabled> 否
					</label>
				</div>
			</div>	
			<div class="am-form-group am-u-md-12">
			  ...
			  <div class="am-u-md-6">
					<label class="am-radio-inline">
						<input type="radio"  value="1" name="CutIf" disabled required> 是
					</label>
					<label class="am-radio-inline">
						<input type="radio" value="0" name="CutIf" disabled> 否
					</label>
				</div>
			</div>
			<!-- <div class="am-form-group am-u-md-12">
			...
			<div class="am-form-group am-u-md-12">
				<input type="checkbox" name="IfFirst" disabled value="1" />
				<label>居住第一层有架空层或木地板住房</label>
			</div>
		</div>
