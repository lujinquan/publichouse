<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:68:"/usr/share/nginx/publichouse/application/ph/view/base_set/index.html";i:1528342025;s:60:"/usr/share/nginx/publichouse/application/ph/view/layout.html";i:1532308676;s:45:"application/ph/view/form/base_set_modify.html";i:1528342025;s:43:"application/ph/view/notice/notice_info.html";i:1528342025;s:42:"application/ph/view/index/second_menu.html";i:1531059200;s:38:"application/ph/view/index/version.html";i:1532308676;}*/ ?>
<!doctype html>
<html class="no-js">
<head>
  <meta charset="utf-8">
...
<div class="admin-content" style="display:none;"></div>
  ...
  <div class="admin-content">
    <div class="am-cf am-padding">
      <div class="am-fl am-cf"><small class="am-text-sm">系统管理</small> > <small class="am-text-primary">基数设置</small></div>
    </div>
      ...
      <div class="am-u-sm-12 am-u-md-8">
        <div class="am-btn-toolbar">
          <div class="am-btn-group-xs">
            <button type="button" id="1" class="conf-class am-btn d-btn-1188F0 am-radius"><span class="am-icon-cog"></span> 各类结构住房租金基价表</button>
            <button type="button" id="2" class="conf-class am-btn d-btn-1188F0 am-radius"><span class="am-icon-cog"></span> 住房使用面积的计算</button>
            <button type="button" id="3" class="conf-class am-btn d-btn-1188F0 am-radius"><span class="am-icon-cog"></span> 住房租金基价折减表</button>
            <button type="button" id="4" class="conf-class am-btn d-btn-1188F0 am-radius"><span class="am-icon-cog"></span> 楼栋层次调节率</button>
            <button type="button" id="5" class="conf-class am-btn d-btn-1188F0 am-radius"><span class="am-icon-cog"></span> 各项加计租金</button>
          </div>
