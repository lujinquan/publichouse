...
$results=$mysqli->query("select HouseID,TenantName,HousePrerent,BanAddress from ph_house where InstitutionID = 7 and OwnerType = 2");
$results = $results->fetch_all(MYSQLI_ASSOC);


// //给报表中的房屋信息加编号
// foreach($results as $res){
//  	$mysqli->query("update old_house_07qu set HouseID = '".$res['HouseID']."' where TenantName = '".$res['TenantName']."'");
// }
...
//获取报表中的所有匹配到房屋编号的数据
$result=$mysqli->query("select HouseID,TenantName,HousePrerent,BanAddress from old_house_07qu where HouseID is not null");

//获取报表中的所有未匹配到房屋编号的数据
$result2=$mysqli->query("select TenantName,HousePrerent,BanAddress from old_house_07qu where HouseID is  null");
